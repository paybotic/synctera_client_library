...
// checks if the CashPickup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CashPickup{}
...
func (o CashPickup) ToMap() (map[string]interface{}, error) {
