...
func (a *KYCKYBVerificationsAPIService) ListVerifications1Execute(r ApiListVerifications1Request) (*VerificationList, *http.Response, error) {
	...
	if r.verificationType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "verification_type", r.verificationType, "csv")
	}
	if r.businessId != nil {
	...
	if r.result != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "result", r.result, "csv")
	}
	if r.personId != nil {
