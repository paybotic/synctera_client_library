...
// checks if the BasePerson1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BasePerson1{}
...
func (o BasePerson1) ToMap() (map[string]interface{}, error) {
