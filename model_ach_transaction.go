...
func (o AchTransaction) MarshalJSON() ([]byte, error) {
...
type NullableAchTransaction struct {
	value *AchTransaction
	isSet bool
}

func (v NullableAchTransaction) Get() *AchTransaction {
	return v.value
}

func (v *NullableAchTransaction) Set(val *AchTransaction) {
	v.value = val
	v.isSet = true
}

func (v NullableAchTransaction) IsSet() bool {
	return v.isSet
}

func (v *NullableAchTransaction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAchTransaction(val *AchTransaction) *NullableAchTransaction {
	return &NullableAchTransaction{value: val, isSet: true}
}

func (v NullableAchTransaction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAchTransaction) UnmarshalJSON(src []byte) error {
	v.isSet = true
