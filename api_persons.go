...
func (r ApiUpdatePersonRequest) Execute() (*PatchPerson, *http.Response, error) {
...
// Execute executes the request
//  @return PatchPerson
func (a *PersonsApiService) UpdatePersonExecute(r ApiUpdatePersonRequest) (*PatchPerson, *http.Response, error) {
	var (
