...
// checks if the WatchlistSuppress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatchlistSuppress{}
...
func (o WatchlistSuppress) ToMap() (map[string]interface{}, error) {
