...
// AccountType The type of the account. In lead mode, this always takes the value of the template. If not specified in shadow mode, CHECKING will be assumed. Below mentioned are the account types: * SAVING: Savings account * CHECKING: Checking account * LINE_OF_CREDIT: Line of Credit account * CHARGE_SECURED: Secured Charge account, e.g. for use in a Smart Charge Card offering 
