...
// checks if the BaseCashPickup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseCashPickup{}
...
func (o BaseCashPickup) ToMap() (map[string]interface{}, error) {
