...
// checks if the AddAccountsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddAccountsRequest{}
...
func (o *AddAccountsRequest) GetVendorAccountId() string {
	if o == nil || IsNil(o.VendorAccountId) {
		var ret string
		return ret
	}
...
func (o AddAccountsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AddAccountsRequest) UnmarshalJSON(data []byte) (err error) {
