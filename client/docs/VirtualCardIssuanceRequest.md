...
`func NewVirtualCardIssuanceRequest(accountId string, cardProductId string, type_ CardType, form string, ) *VirtualCardIssuanceRequest`
...
`func (o *VirtualCardIssuanceRequest) GetBusinessId() string`

GetBusinessId returns the BusinessId field if non-nil, zero value otherwise.

### GetBusinessIdOk

`func (o *VirtualCardIssuanceRequest) GetBusinessIdOk() (*string, bool)`
...
`func (o *VirtualCardIssuanceRequest) SetBusinessId(v string)`

SetBusinessId sets BusinessId field to given value.

### HasBusinessId

`func (o *VirtualCardIssuanceRequest) HasBusinessId() bool`
...
`func (o *VirtualCardIssuanceRequest) HasCustomerId() bool`
