...
// checks if the PlaidAccountVerification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlaidAccountVerification{}
...
type _PlaidAccountVerification PlaidAccountVerification
...
func (o PlaidAccountVerification) ToMap() (map[string]interface{}, error) {
...
func (o *PlaidAccountVerification) UnmarshalJSON(data []byte) (err error) {
	...
	varPlaidAccountVerification := _PlaidAccountVerification{}

	err = json.Unmarshal(data, &varPlaidAccountVerification)

	if err != nil {
		return err
	}

	*o = PlaidAccountVerification(varPlaidAccountVerification)
