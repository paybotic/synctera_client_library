...
// checks if the ExternalAccountVendorData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalAccountVendorData{}
...
func (o *ExternalAccountVendorData) GetAccountNumberMask() string {
	if o == nil || IsNil(o.AccountNumberMask) {
		var ret string
		return ret
	}
...
func (o ExternalAccountVendorData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AccountNumberMask) {
