...
type _EstimatedRevenue EstimatedRevenue
...
func (o *EstimatedRevenue) UnmarshalJSON(data []byte) (err error) {
	varEstimatedRevenue := _EstimatedRevenue{}

	err = json.Unmarshal(data, &varEstimatedRevenue)

	if err != nil {
		return err
	}

	*o = EstimatedRevenue(varEstimatedRevenue)
