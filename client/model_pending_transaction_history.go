...
// checks if the PendingTransactionHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PendingTransactionHistory{}
...
type _PendingTransactionHistory PendingTransactionHistory
...
func (o PendingTransactionHistory) ToMap() (map[string]interface{}, error) {
...
func (o *PendingTransactionHistory) UnmarshalJSON(data []byte) (err error) {
	...
	varPendingTransactionHistory := _PendingTransactionHistory{}

	err = json.Unmarshal(data, &varPendingTransactionHistory)

	if err != nil {
		return err
	}

	*o = PendingTransactionHistory(varPendingTransactionHistory)
