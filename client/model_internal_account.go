...
// checks if the InternalAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalAccount{}
...
type _InternalAccount InternalAccount
...
func (o InternalAccount) ToMap() (map[string]interface{}, error) {
...
func (o *InternalAccount) UnmarshalJSON(data []byte) (err error) {
	...
	varInternalAccount := _InternalAccount{}

	err = json.Unmarshal(data, &varInternalAccount)

	if err != nil {
		return err
	}

	*o = InternalAccount(varInternalAccount)
