...
type _DisclosureList DisclosureList
...
func (o *DisclosureList) UnmarshalJSON(data []byte) (err error) {
	...
	varDisclosureList := _DisclosureList{}

	err = json.Unmarshal(data, &varDisclosureList)

	if err != nil {
		return err
	}

	*o = DisclosureList(varDisclosureList)
