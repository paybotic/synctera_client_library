...
// checks if the PendingTransactionHistoryData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PendingTransactionHistoryData{}
...
func (o PendingTransactionHistoryData) ToMap() (map[string]interface{}, error) {
...
func (o *PendingTransactionHistoryData) UnmarshalJSON(data []byte) (err error) {
