...
func (r ApiCreateDocumentRequest) BatchId(batchId string) ApiCreateDocumentRequest {
	r.batchId = &batchId
	return r
}
...
func (r ApiCreateDocumentRequest) Encryption(encryption DocumentEncryption) ApiCreateDocumentRequest {
...
func (r ApiCreateDocumentRequest) Metadata(metadata string) ApiCreateDocumentRequest {
	r.metadata = &metadata
	return r
}
...
func (a *DocumentsAPIService) CreateDocumentExecute(r ApiCreateDocumentRequest) (*DocumentResponse, *http.Response, error) {
	...
	if r.batchId != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "batch_id", r.batchId, "", "")
	}
...
type ApiCreateDocumentVersionRequest struct {
	...
	file        *os.File
	description *string
	encryption  *DocumentEncryptionVersionPost
	name        *string
	type_       *DocumentType
}
...
func (r ApiCreateDocumentVersionRequest) Encryption(encryption DocumentEncryptionVersionPost) ApiCreateDocumentVersionRequest {
	r.encryption = &encryption
	return r
}
...
func (r ApiCreateDocumentVersionRequest) Execute() (*DocumentResponse, *http.Response, error) {
...
//
//	@return DocumentResponse
func (a *DocumentsAPIService) CreateDocumentVersionExecute(r ApiCreateDocumentVersionRequest) (*DocumentResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiDeleteDocumentRequest) Execute() (*DeleteResponse, *http.Response, error) {
...
func (a *DocumentsAPIService) DeleteDocumentExecute(r ApiDeleteDocumentRequest) (*DeleteResponse, *http.Response, error) {
	var (
...
func (r ApiGetDocumentVersionRequest) Execute() (*DocumentResponse, *http.Response, error) {
...
//
//	@return DocumentResponse
func (a *DocumentsAPIService) GetDocumentVersionExecute(r ApiGetDocumentVersionRequest) (*DocumentResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListDocumentsRequest) BatchId(batchId string) ApiListDocumentsRequest {
	r.batchId = &batchId
	return r
}
...
func (a *DocumentsAPIService) ListDocumentsExecute(r ApiListDocumentsRequest) (*DocumentList, *http.Response, error) {
	...
	if r.encryption != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "encryption", r.encryption, "form", "")
	}
	if r.pageToken != nil {
...
func (r ApiUpdateDocumentRequest) DocumentPatch(documentPatch DocumentPatch) ApiUpdateDocumentRequest {
	r.documentPatch = &documentPatch
	return r
}
...
func (a *DocumentsAPIService) UpdateDocumentExecute(r ApiUpdateDocumentRequest) (*DocumentResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.documentPatch == nil {
		return localVarReturnValue, nil, reportError("documentPatch is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.documentPatch
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
