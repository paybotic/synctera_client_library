...
// checks if the CustomerVerifyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerVerifyResponse{}
...
func (o CustomerVerifyResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CustomerVerifyResponse) UnmarshalJSON(data []byte) (err error) {
