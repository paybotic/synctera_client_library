...
// checks if the VirtualCardIssuanceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualCardIssuanceRequest{}
...
func (o VirtualCardIssuanceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualCardIssuanceRequest) UnmarshalJSON(data []byte) (err error) {
