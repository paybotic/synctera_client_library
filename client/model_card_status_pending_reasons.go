...
type _CardStatusPendingReasons CardStatusPendingReasons
...
func (o *CardStatusPendingReasons) UnmarshalJSON(data []byte) (err error) {
	varCardStatusPendingReasons := _CardStatusPendingReasons{}

	err = json.Unmarshal(data, &varCardStatusPendingReasons)

	if err != nil {
		return err
	}

	*o = CardStatusPendingReasons(varCardStatusPendingReasons)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "is_waiting_for_bulk_shipment")
		delete(additionalProperties, "is_waiting_for_image")
		delete(additionalProperties, "is_waiting_for_pin")
