...
// checks if the AddVendorAccountsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddVendorAccountsRequest{}
...
func (o *AddVendorAccountsRequest) GetVendorAccountIds() []string {
	if o == nil || IsNil(o.VendorAccountIds) {
		var ret []string
		return ret
	}
...
func (o AddVendorAccountsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AddVendorAccountsRequest) UnmarshalJSON(data []byte) (err error) {
