...
// SandboxWipeAPIService SandboxWipeAPI service
type SandboxWipeAPIService service

type ApiWipeWorkspaceRequest struct {
	ctx        context.Context
	ApiService *SandboxWipeAPIService
}
...
*/
func (a *SandboxWipeAPIService) WipeWorkspace(ctx context.Context) ApiWipeWorkspaceRequest {
	return ApiWipeWorkspaceRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SandboxWipeAPIService) WipeWorkspaceExecute(r ApiWipeWorkspaceRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SandboxWipeAPIService.WipeWorkspace")
	if err != nil {
