...
func main() {
    verification := *openapiclient.NewVerification(openapiclient.verification_result("UNVERIFIED"), time.Now(), openapiclient.verification_type1("IDENTITY")) // Verification | Verification result to create.
