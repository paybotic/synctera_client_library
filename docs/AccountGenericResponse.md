...
**ApplicationId** | **string** | The application ID for this account.  | [optional] [default to null]
...
**BusinessIds** | **[]string** | A list of the business IDs of the account holders. | [optional] [default to null]
