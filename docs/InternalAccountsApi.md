...
func main() {
    internalAccount := *openapiclient.NewInternalAccount("LAK", "Status_example") // InternalAccount | 
...
func main() {
    internalAccountId := "69c8bfb7-a0ab-4b55-9f2b-6d8065d71220" // string | Unique identifier for the internal account.
