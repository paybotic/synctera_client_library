...
func main() {
    addAccountsRequest := *openapiclient.NewAddAccountsRequest(*openapiclient.NewAddAccountsRequestAccountIdentifiers("78277121"), []string{"Jodi Larkin"}, openapiclient.ext_account_customer_type("PERSONAL"), *openapiclient.NewAddAccountsRequestRoutingIdentifiers("756392185", []string{"BankCountries_example"}, "Chase"), "Type_example") // AddAccountsRequest | 
...
func main() {
    externalAccountId := "dd8cd509-ce52-4990-8f84-316558e68e9a" // string | External Account ID
...
func main() {
    externalAccountId := "dd8cd509-ce52-4990-8f84-316558e68e9a" // string | External Account ID
    maxAge := int64(861) // int64 | Optional relative age of a balance in seconds. If the balance is older than the requested seconds it will fail. This field is optional for most financial institutions, but required for some, so you should probably send it.  (optional)
...
func main() {
    ...
    businessId := []string{"7087a6a6-706e-4007-88d5-3e8134e0675d"} // []string | A list of business unique identifiers, with a comma separating any values. (optional)
