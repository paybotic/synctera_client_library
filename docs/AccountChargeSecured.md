...
**Note** | Pointer to **string** | Add an optional note when creating or updating a charged secured account. A note is required when updating the status to or from SUSPENDED | [optional] 
