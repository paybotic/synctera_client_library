...
func main() {
    relationshipIn := openapiclient.relationship_in{BusinessBusinessOwnerRelationship: openapiclient.NewBusinessBusinessOwnerRelationship(*openapiclient.NewAdditionalOwnerData(float64(35.75)), "7d943c51-e4ff-4e57-9558-08cab6b963c7", "BENEFICIAL_OWNER_OF", "7d943c51-e4ff-4e57-9558-08cab6b963c7")} // RelationshipIn | Party relationship to create.
