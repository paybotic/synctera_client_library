...
`func (o *CardProductInternal) GetIssueWithoutKyc() bool`

GetIssueWithoutKyc returns the IssueWithoutKyc field if non-nil, zero value otherwise.

### GetIssueWithoutKycOk

`func (o *CardProductInternal) GetIssueWithoutKycOk() (*bool, bool)`
...
`func (o *CardProductInternal) SetIssueWithoutKyc(v bool)`

SetIssueWithoutKyc sets IssueWithoutKyc field to given value.

### HasIssueWithoutKyc

`func (o *CardProductInternal) HasIssueWithoutKyc() bool`
