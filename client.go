...
// APIClient manages communication with the Synctera API API v0.17.0
...
type APIClient struct {
	...
	RemoteCheckDepositApi *RemoteCheckDepositApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.RemoteCheckDepositApi = (*RemoteCheckDepositApiService)(&c.common)
