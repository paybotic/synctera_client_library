...
// checks if the ManualAccountVerification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManualAccountVerification{}
...
func (o ManualAccountVerification) ToMap() (map[string]interface{}, error) {
...
func (o *ManualAccountVerification) UnmarshalJSON(data []byte) (err error) {
