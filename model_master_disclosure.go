...
type MasterDisclosure struct {
	...
	// The id tenant containing the resource. Tenancy is represented as <bank_id>_<partner_id>. This attribute is included on all responses. In requests, it is optional for clients with access to only a single tenant. 
