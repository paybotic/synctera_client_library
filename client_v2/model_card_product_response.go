...
type CardProductResponse struct {
	...
	BulkShippingEnabled bool `json:"bulk_shipping_enabled"`
	...
	OfflinePin *bool `json:"offline_pin,omitempty"`
	// Card orientation
	...
	PinIssuancePolicy  *PinIssuancePolicy  `json:"pin_issuance_policy,omitempty"`
	...
	// Indicates whether unsecured credit is enabled for this card product
	UnsecuredCreditEnabled bool `json:"unsecured_credit_enabled"`
	// The unique identifier of a account range
	AccountRangeId string `json:"account_range_id"`
	// The unique identifier of a bin
	BinId           string          `json:"bin_id"`
	IssuerProcessor IssuerProcessor `json:"issuer_processor"`
...
func NewCardProductResponse(form string, active bool, bulkShippingEnabled bool, cardProgramId string, creationTime time.Time, digitalWalletTokenization DigitalWalletTokenization, endDate time.Time, id string, lastUpdatedTime time.Time, name string, startDate time.Time, unsecuredCreditEnabled bool, accountRangeId string, binId string, issuerProcessor IssuerProcessor, tenant string, threeDsPolicy ThreeDsPolicy) *CardProductResponse {
	...
	this.Form = form
	this.Active = active
	this.BulkShippingEnabled = bulkShippingEnabled
	...
	this.UnsecuredCreditEnabled = unsecuredCreditEnabled
	this.AccountRangeId = accountRangeId
	this.BinId = binId
	this.IssuerProcessor = issuerProcessor
	this.Tenant = tenant
...
func NewCardProductResponseWithDefaults() *CardProductResponse {
	this := CardProductResponse{}
	var bulkShippingEnabled bool = false
	this.BulkShippingEnabled = bulkShippingEnabled
	var crossBorderEnabled bool = false
	this.CrossBorderEnabled = &crossBorderEnabled
	var l2l3Enabled bool = false
	...
	var txnEnhancer TxnEnhancer = TXNENHANCER_MX
	this.TxnEnhancer = &txnEnhancer
	var unsecuredCreditEnabled bool = false
	this.UnsecuredCreditEnabled = unsecuredCreditEnabled
	return &this
}
...
// GetBulkShippingEnabled returns the BulkShippingEnabled field value
func (o *CardProductResponse) GetBulkShippingEnabled() bool {
	...
	return o.BulkShippingEnabled
}

// GetBulkShippingEnabledOk returns a tuple with the BulkShippingEnabled field value
// and a boolean to check if the value has been set.
func (o *CardProductResponse) GetBulkShippingEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.BulkShippingEnabled, true
}

// SetBulkShippingEnabled sets field value
func (o *CardProductResponse) SetBulkShippingEnabled(v bool) {
	o.BulkShippingEnabled = v
}
...
// GetOfflinePin returns the OfflinePin field value if set, zero value otherwise.
func (o *CardProductResponse) GetOfflinePin() bool {
	if o == nil || IsNil(o.OfflinePin) {
		var ret bool
		return ret
	}
	return *o.OfflinePin
...
// GetOfflinePinOk returns a tuple with the OfflinePin field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CardProductResponse) GetOfflinePinOk() (*bool, bool) {
	if o == nil || IsNil(o.OfflinePin) {
		return nil, false
	}
	return o.OfflinePin, true
}
...
// SetOfflinePin gets a reference to the given bool and assigns it to the OfflinePin field.
...
// GetPinIssuancePolicy returns the PinIssuancePolicy field value if set, zero value otherwise.
func (o *CardProductResponse) GetPinIssuancePolicy() PinIssuancePolicy {
	if o == nil || IsNil(o.PinIssuancePolicy) {
		var ret PinIssuancePolicy
		return ret
	}
	return *o.PinIssuancePolicy
}

// GetPinIssuancePolicyOk returns a tuple with the PinIssuancePolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CardProductResponse) GetPinIssuancePolicyOk() (*PinIssuancePolicy, bool) {
	if o == nil || IsNil(o.PinIssuancePolicy) {
		return nil, false
	}
	return o.PinIssuancePolicy, true
}
...
// SetPinIssuancePolicy gets a reference to the given PinIssuancePolicy and assigns it to the PinIssuancePolicy field.
func (o *CardProductResponse) SetPinIssuancePolicy(v PinIssuancePolicy) {
	o.PinIssuancePolicy = &v
}
...
// GetUnsecuredCreditEnabled returns the UnsecuredCreditEnabled field value
func (o *CardProductResponse) GetUnsecuredCreditEnabled() bool {
	...
	return o.UnsecuredCreditEnabled
}

// GetUnsecuredCreditEnabledOk returns a tuple with the UnsecuredCreditEnabled field value
// and a boolean to check if the value has been set.
func (o *CardProductResponse) GetUnsecuredCreditEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UnsecuredCreditEnabled, true
}

// SetUnsecuredCreditEnabled sets field value
func (o *CardProductResponse) SetUnsecuredCreditEnabled(v bool) {
	o.UnsecuredCreditEnabled = v
}
...
// GetIssuerProcessor returns the IssuerProcessor field value
func (o *CardProductResponse) GetIssuerProcessor() IssuerProcessor {
	if o == nil {
		var ret IssuerProcessor
		return ret
	}
...
// GetIssuerProcessorOk returns a tuple with the IssuerProcessor field value
// and a boolean to check if the value has been set.
...
// SetIssuerProcessor sets field value
...
func (o CardProductResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["bulk_shipping_enabled"] = o.BulkShippingEnabled
	...
	if !IsNil(o.OfflinePin) {
		toSerialize["offline_pin"] = o.OfflinePin
	}
	...
	if !IsNil(o.PinIssuancePolicy) {
		toSerialize["pin_issuance_policy"] = o.PinIssuancePolicy
	}
	...
	toSerialize["unsecured_credit_enabled"] = o.UnsecuredCreditEnabled
...
func (o *CardProductResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CardProductResponse(varCardProductResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "bulk_shipping_enabled")
		...
		delete(additionalProperties, "offline_pin")
		...
		delete(additionalProperties, "pin_issuance_policy")
		delete(additionalProperties, "return_address")
		delete(additionalProperties, "start_date")
		delete(additionalProperties, "txn_enhancer")
		delete(additionalProperties, "unsecured_credit_enabled")
		delete(additionalProperties, "account_range_id")
		delete(additionalProperties, "bin_id")
		delete(additionalProperties, "issuer_processor")
