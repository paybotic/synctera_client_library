...
type TransferResponse struct {
	...
	TransferResponseToken *TransferResponseToken
}
...
// TransferResponseTokenAsTransferResponse is a convenience function that returns TransferResponseToken wrapped in TransferResponse
func TransferResponseTokenAsTransferResponse(v *TransferResponseToken) TransferResponse {
	return TransferResponse{
		TransferResponseToken: v,
	}
}
...
func (dst *TransferResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'APPLE_PAY_PULL'
	if jsonDict["type"] == "APPLE_PAY_PULL" {
		// try to unmarshal JSON data into TransferResponseToken
		err = json.Unmarshal(data, &dst.TransferResponseToken)
		if err == nil {
			return nil // data stored in dst.TransferResponseToken, return on the first match
		} else {
			dst.TransferResponseToken = nil
			return fmt.Errorf("failed to unmarshal TransferResponse as TransferResponseToken: %s", err.Error())
		}
	}

	// check if the discriminator value is 'APPLE_PAY_PULL_REVERSAL'
	if jsonDict["type"] == "APPLE_PAY_PULL_REVERSAL" {
		// try to unmarshal JSON data into TransferResponseToken
		err = json.Unmarshal(data, &dst.TransferResponseToken)
		if err == nil {
			return nil // data stored in dst.TransferResponseToken, return on the first match
	...
	// check if the discriminator value is 'GOOGLE_PAY_PULL'
	if jsonDict["type"] == "GOOGLE_PAY_PULL" {
		// try to unmarshal JSON data into TransferResponseToken
		err = json.Unmarshal(data, &dst.TransferResponseToken)
		if err == nil {
			return nil // data stored in dst.TransferResponseToken, return on the first match
	...
	// check if the discriminator value is 'GOOGLE_PAY_PULL_REVERSAL'
	if jsonDict["type"] == "GOOGLE_PAY_PULL_REVERSAL" {
		// try to unmarshal JSON data into TransferResponseToken
		err = json.Unmarshal(data, &dst.TransferResponseToken)
		if err == nil {
			return nil // data stored in dst.TransferResponseToken, return on the first match
...
func (src TransferResponse) MarshalJSON() ([]byte, error) {
	...
	if src.TransferResponseToken != nil {
		return json.Marshal(&src.TransferResponseToken)
	}
...
func (obj *TransferResponse) GetActualInstance() interface{} {
	...
	if obj.TransferResponseToken != nil {
		return obj.TransferResponseToken
	}
