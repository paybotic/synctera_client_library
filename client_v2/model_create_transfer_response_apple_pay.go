...
// checks if the CreateTransferResponseApplePay type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTransferResponseApplePay{}

// CreateTransferResponseApplePay struct for CreateTransferResponseApplePay
type CreateTransferResponseApplePay struct {
...
type _CreateTransferResponseApplePay CreateTransferResponseApplePay
...
func NewCreateTransferResponseApplePay(accountId string, amount int32, creationTime time.Time, currency string, customerId string, id string, lastUpdatedTime time.Time, merchant Merchant, status TransferStatus, tenant string, cardDetails ExternalCardDetails, type_ string) *CreateTransferResponseApplePay {
	this := CreateTransferResponseApplePay{}
...
func (o CreateTransferResponseApplePay) MarshalJSON() ([]byte, error) {
...
func (o CreateTransferResponseApplePay) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTransferResponseApplePay) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTransferResponseApplePay := _CreateTransferResponseApplePay{}

	err = json.Unmarshal(data, &varCreateTransferResponseApplePay)

	if err != nil {
		return err
	}

	*o = CreateTransferResponseApplePay(varCreateTransferResponseApplePay)
...
type NullableCreateTransferResponseApplePay struct {
	value *CreateTransferResponseApplePay
	isSet bool
}

func (v NullableCreateTransferResponseApplePay) Get() *CreateTransferResponseApplePay {
	return v.value
}

func (v *NullableCreateTransferResponseApplePay) Set(val *CreateTransferResponseApplePay) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTransferResponseApplePay) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTransferResponseApplePay) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTransferResponseApplePay(val *CreateTransferResponseApplePay) *NullableCreateTransferResponseApplePay {
	return &NullableCreateTransferResponseApplePay{value: val, isSet: true}
}

func (v NullableCreateTransferResponseApplePay) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTransferResponseApplePay) UnmarshalJSON(src []byte) error {
	v.isSet = true
