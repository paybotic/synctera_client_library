...
// checks if the BaseCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseCard{}
...
func (o BaseCard) ToMap() (map[string]interface{}, error) {
...
func (o *BaseCard) UnmarshalJSON(data []byte) (err error) {
