...
type PaymentScheduleList struct {
	...
	PaymentSchedules     []PaymentScheduleResponse `json:"payment_schedules"`
...
func (o *PaymentScheduleList) GetPaymentSchedules() []PaymentScheduleResponse {
	if o == nil {
		var ret []PaymentScheduleResponse
		return ret
	}
...
func (o *PaymentScheduleList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPaymentScheduleList)
	...
	*o = PaymentScheduleList(varPaymentScheduleList)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "payment_schedules")
