...
const (
	...
	ACCOUNTRELATIONSHIPTYPE_AUTHORIZED_USER        AccountRelationshipType = "AUTHORIZED_USER"
	ACCOUNTRELATIONSHIPTYPE_BENEFICIARY            AccountRelationshipType = "BENEFICIARY"
)
