...
// Card ID
func (r ApiSimulateCardFulfillmentEventRequest) CardId(cardId string) ApiSimulateCardFulfillmentEventRequest {
	r.cardId = &cardId
	return r
}
...
*/
func (a *CardWebhookSimulationsAPIService) SimulateCardFulfillmentEvent(ctx context.Context) ApiSimulateCardFulfillmentEventRequest {
	return ApiSimulateCardFulfillmentEventRequest{
		ApiService: a,
		ctx:        ctx,
	}
