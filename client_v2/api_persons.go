...
/*
CreatePersonalId Create a personal identifier
...
/*
DeletePersonalId Delete a personal identifier
...
type ApiListPersonsRequest struct {
	...
	sortBy              *[]string
	hasAccounts         *bool
	includeConsoleUsers *bool
	classifications     *[]Classification
}

// Transaction UUID(s). Multiple UUIDs can be provided as a comma-separated list.
func (r ApiListPersonsRequest) Uuid(uuid []string) ApiListPersonsRequest {
	r.uuid = &uuid
	return r
}
...
func (r ApiListPersonsRequest) Dob(dob string) ApiListPersonsRequest {
	r.dob = &dob
	return r
}
...
func (r ApiListPersonsRequest) IncludeConsoleUsers(includeConsoleUsers bool) ApiListPersonsRequest {
	r.includeConsoleUsers = &includeConsoleUsers
	return r
}

// Specifies the classification of a party for banks. It can contain multiple values.
func (r ApiListPersonsRequest) Classifications(classifications []Classification) ApiListPersonsRequest {
...
func (a *PersonsAPIService) ListPersonsExecute(r ApiListPersonsRequest) (*PersonList, *http.Response, error) {
	...
	if r.dob != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "dob", r.dob, "form", "")
	}
	...
	if r.banStatus != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ban_status", r.banStatus, "form", "csv")
	}
	if r.status != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "status", r.status, "form", "")
	}
	if r.verificationStatus != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "verification_status", r.verificationStatus, "form", "csv")
	}
	if r.isCustomer != nil {
	...
	if r.includeConsoleUsers != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "include_console_users", r.includeConsoleUsers, "form", "")
	}
...
type ApiRevealPersonalIdRequest struct {
	ctx                       context.Context
	ApiService                *PersonsAPIService
	personalIdId              string
	personalIdConfigurationId *string
}
...
func (r ApiRevealPersonalIdRequest) PersonalIdConfigurationId(personalIdConfigurationId string) ApiRevealPersonalIdRequest {
	r.personalIdConfigurationId = &personalIdConfigurationId
	return r
}

func (r ApiRevealPersonalIdRequest) Execute() (*PersonalIdRevealResponse, *http.Response, error) {
	return r.ApiService.RevealPersonalIdExecute(r)
}

/*
RevealPersonalId Reveal Personal ID
...
If not specified, the oldest configured public key will be used.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param personalIdId UUID for a personal identifier.
	@return ApiRevealPersonalIdRequest
*/
func (a *PersonsAPIService) RevealPersonalId(ctx context.Context, personalIdId string) ApiRevealPersonalIdRequest {
	return ApiRevealPersonalIdRequest{
		ApiService:   a,
		ctx:          ctx,
		personalIdId: personalIdId,
...
// Execute executes the request
//
//	@return PersonalIdRevealResponse
func (a *PersonsAPIService) RevealPersonalIdExecute(r ApiRevealPersonalIdRequest) (*PersonalIdRevealResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PersonalIdRevealResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonsAPIService.RevealPersonalId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/persons/personal_ids/{personal_id_id}/reveal"
	localVarPath = strings.Replace(localVarPath, "{"+"personal_id_id"+"}", url.PathEscape(parameterValueToString(r.personalIdId, "personalIdId")), -1)
	...
	if r.personalIdConfigurationId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "personal_id_configuration_id", r.personalIdConfigurationId, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
/*
UpdatePersonalId Update a personal identifier
