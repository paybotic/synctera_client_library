...
// checks if the AdhocVerificationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdhocVerificationResponse{}
...
func (o AdhocVerificationResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AdhocVerificationResponse) UnmarshalJSON(data []byte) (err error) {
