...
// checks if the RewardTemplateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RewardTemplateResponse{}

// RewardTemplateResponse struct for RewardTemplateResponse
type RewardTemplateResponse struct {
	...
	// The timestamp representing when the reward template was created
	CreationTime time.Time `json:"creation_time"`
	// The ID of the reward template.
	Id string `json:"id"`
	// The timestamp representing when the reward template was last modified
...
type _RewardTemplateResponse RewardTemplateResponse
...
func (o RewardTemplateResponse) MarshalJSON() ([]byte, error) {
...
func (o RewardTemplateResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RewardTemplateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRewardTemplateResponse := _RewardTemplateResponse{}

	err = json.Unmarshal(data, &varRewardTemplateResponse)

	if err != nil {
		return err
	}

	*o = RewardTemplateResponse(varRewardTemplateResponse)
...
type NullableRewardTemplateResponse struct {
	value *RewardTemplateResponse
	isSet bool
}

func (v NullableRewardTemplateResponse) Get() *RewardTemplateResponse {
	return v.value
}

func (v *NullableRewardTemplateResponse) Set(val *RewardTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRewardTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRewardTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRewardTemplateResponse(val *RewardTemplateResponse) *NullableRewardTemplateResponse {
	return &NullableRewardTemplateResponse{value: val, isSet: true}
}

func (v NullableRewardTemplateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRewardTemplateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
