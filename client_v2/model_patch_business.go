...
type PatchBusiness struct {
	...
	CustomerActive *time.Time `json:"customer_active,omitempty"`
	...
	VendorInfo           *PartyVendorInfo `json:"vendor_info,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PatchBusiness PatchBusiness
...
// GetCustomerActive returns the CustomerActive field value if set, zero value otherwise.
func (o *PatchBusiness) GetCustomerActive() time.Time {
	if o == nil || IsNil(o.CustomerActive) {
		var ret time.Time
		return ret
	}
	return *o.CustomerActive
}

// GetCustomerActiveOk returns a tuple with the CustomerActive field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PatchBusiness) GetCustomerActiveOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CustomerActive) {
		return nil, false
	}
	return o.CustomerActive, true
}
...
// SetCustomerActive gets a reference to the given time.Time and assigns it to the CustomerActive field.
...
// SetVendorInfo gets a reference to the given PartyVendorInfo and assigns it to the VendorInfo field.
...
func (o PatchBusiness) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CustomerActive) {
		toSerialize["customer_active"] = o.CustomerActive
	}
	if !IsNil(o.Ein) {
...
func (o *PatchBusiness) UnmarshalJSON(data []byte) (err error) {
	varPatchBusiness := _PatchBusiness{}

	err = json.Unmarshal(data, &varPatchBusiness)

	if err != nil {
		return err
	}

	*o = PatchBusiness(varPatchBusiness)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "customer_active")
