...
// checks if the PhysicalDebitCardResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalDebitCardResponse{}

// PhysicalDebitCardResponse A card that can spend against a deposit account
type PhysicalDebitCardResponse struct {
	// PHYSICAL or VIRTUAL.
...
type _PhysicalDebitCardResponse PhysicalDebitCardResponse
...
func NewPhysicalDebitCardResponse(form string, accountId string, cardProductId string, creationTime time.Time, embossName EmbossName, id string, shipping Shipping, cardStatus CardStatus, statusReason CardStatusReasonCode, cardFulfillmentStatus CardFulfillmentStatus, cardBrand CardBrand, physicalCardFormat PhysicalCardFormat) *PhysicalDebitCardResponse {
	this := PhysicalDebitCardResponse{}
	this.Form = form
...
func (o PhysicalDebitCardResponse) MarshalJSON() ([]byte, error) {
...
func (o PhysicalDebitCardResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PhysicalDebitCardResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPhysicalDebitCardResponse := _PhysicalDebitCardResponse{}

	err = json.Unmarshal(data, &varPhysicalDebitCardResponse)

	if err != nil {
		return err
	}

	*o = PhysicalDebitCardResponse(varPhysicalDebitCardResponse)
...
type NullablePhysicalDebitCardResponse struct {
	value *PhysicalDebitCardResponse
	isSet bool
}

func (v NullablePhysicalDebitCardResponse) Get() *PhysicalDebitCardResponse {
	return v.value
}

func (v *NullablePhysicalDebitCardResponse) Set(val *PhysicalDebitCardResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePhysicalDebitCardResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePhysicalDebitCardResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhysicalDebitCardResponse(val *PhysicalDebitCardResponse) *NullablePhysicalDebitCardResponse {
	return &NullablePhysicalDebitCardResponse{value: val, isSet: true}
}

func (v NullablePhysicalDebitCardResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhysicalDebitCardResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
