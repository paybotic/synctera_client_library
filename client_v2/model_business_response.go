...
// checks if the BusinessResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BusinessResponse{}
...
type _BusinessResponse BusinessResponse
...
func (o BusinessResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BusinessResponse) UnmarshalJSON(data []byte) (err error) {
	varBusinessResponse := _BusinessResponse{}

	err = json.Unmarshal(data, &varBusinessResponse)

	if err != nil {
		return err
	}

	*o = BusinessResponse(varBusinessResponse)
