...
type ApiCreateSpendControlRequest struct {
	...
	spendControlCreationRequest *SpendControlCreationRequest
}

// Details of the spend control to create
func (r ApiCreateSpendControlRequest) SpendControlCreationRequest(spendControlCreationRequest SpendControlCreationRequest) ApiCreateSpendControlRequest {
	r.spendControlCreationRequest = &spendControlCreationRequest
	return r
}
...
func (a *SpendControlsBetaAPIService) CreateSpendControlExecute(r ApiCreateSpendControlRequest) (*SpendControlResponse, *http.Response, error) {
	...
	if r.spendControlCreationRequest == nil {
		return localVarReturnValue, nil, reportError("spendControlCreationRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.spendControlCreationRequest
...
type ApiListSpendControlsRequest struct {
	...
	transactionCountLimit    *int32
	transactionCountLimitGte *int32
	transactionCountLimitLte *int32
...
// return results matching this transaction count limit
func (r ApiListSpendControlsRequest) TransactionCountLimit(transactionCountLimit int32) ApiListSpendControlsRequest {
	r.transactionCountLimit = &transactionCountLimit
	return r
}

// return results with a transaction count limit greater than or equal to this
func (r ApiListSpendControlsRequest) TransactionCountLimitGte(transactionCountLimitGte int32) ApiListSpendControlsRequest {
	r.transactionCountLimitGte = &transactionCountLimitGte
	return r
}

// return results with a transaction count limit less than or equal to this
func (r ApiListSpendControlsRequest) TransactionCountLimitLte(transactionCountLimitLte int32) ApiListSpendControlsRequest {
	r.transactionCountLimitLte = &transactionCountLimitLte
	return r
}
...
// return results with this time range type
func (r ApiListSpendControlsRequest) TimeRangeType(timeRangeType []string) ApiListSpendControlsRequest {
...
func (a *SpendControlsBetaAPIService) ListSpendControlsExecute(r ApiListSpendControlsRequest) (*SpendControlResponseList, *http.Response, error) {
	...
	if r.transactionCountLimit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "transaction_count_limit", r.transactionCountLimit, "form", "")
	}
	if r.transactionCountLimitGte != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "transaction_count_limit_gte", r.transactionCountLimitGte, "form", "")
	}
	if r.transactionCountLimitLte != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "transaction_count_limit_lte", r.transactionCountLimitLte, "form", "")
	}
	...
	if r.timeRangeType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "time_range_type", r.timeRangeType, "form", "csv")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
