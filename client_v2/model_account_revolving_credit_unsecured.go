...
// checks if the AccountRevolvingCreditUnsecured type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountRevolvingCreditUnsecured{}

// AccountRevolvingCreditUnsecured Account representing an unsecured revolving credit account.
type AccountRevolvingCreditUnsecured struct {
...
type _AccountRevolvingCreditUnsecured AccountRevolvingCreditUnsecured
...
func NewAccountRevolvingCreditUnsecured() *AccountRevolvingCreditUnsecured {
	this := AccountRevolvingCreditUnsecured{}
	return &this
}
...
func (o AccountRevolvingCreditUnsecured) MarshalJSON() ([]byte, error) {
...
func (o AccountRevolvingCreditUnsecured) ToMap() (map[string]interface{}, error) {
...
func (o *AccountRevolvingCreditUnsecured) UnmarshalJSON(data []byte) (err error) {
	varAccountRevolvingCreditUnsecured := _AccountRevolvingCreditUnsecured{}

	err = json.Unmarshal(data, &varAccountRevolvingCreditUnsecured)

	if err != nil {
		return err
	}

	*o = AccountRevolvingCreditUnsecured(varAccountRevolvingCreditUnsecured)
...
type NullableAccountRevolvingCreditUnsecured struct {
	value *AccountRevolvingCreditUnsecured
	isSet bool
}

func (v NullableAccountRevolvingCreditUnsecured) Get() *AccountRevolvingCreditUnsecured {
	return v.value
}

func (v *NullableAccountRevolvingCreditUnsecured) Set(val *AccountRevolvingCreditUnsecured) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountRevolvingCreditUnsecured) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountRevolvingCreditUnsecured) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountRevolvingCreditUnsecured(val *AccountRevolvingCreditUnsecured) *NullableAccountRevolvingCreditUnsecured {
	return &NullableAccountRevolvingCreditUnsecured{value: val, isSet: true}
}

func (v NullableAccountRevolvingCreditUnsecured) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountRevolvingCreditUnsecured) UnmarshalJSON(src []byte) error {
	v.isSet = true
