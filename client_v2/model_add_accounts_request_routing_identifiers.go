...
type AddAccountsRequestRoutingIdentifiers struct {
	...
	Network                  *ExternalAccountNetwork   `json:"network,omitempty"`
...
func (o *AddAccountsRequestRoutingIdentifiers) GetNetwork() ExternalAccountNetwork {
	if o == nil || IsNil(o.Network) {
		var ret ExternalAccountNetwork
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given ExternalAccountNetwork and assigns it to the Network field.
