...
// GetManualAccountNumber returns the ManualAccountNumber field value if set, zero value otherwise.
func (o *AccountCreation) GetManualAccountNumber() string {
	if o == nil || IsNil(o.ManualAccountNumber) {
		var ret string
		return ret
	}
	return *o.ManualAccountNumber
}

// GetManualAccountNumberOk returns a tuple with the ManualAccountNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AccountCreation) GetManualAccountNumberOk() (*string, bool) {
	if o == nil || IsNil(o.ManualAccountNumber) {
		return nil, false
	}
	return o.ManualAccountNumber, true
}
...
// SetManualAccountNumber gets a reference to the given string and assigns it to the ManualAccountNumber field.
func (o *AccountCreation) SetManualAccountNumber(v string) {
	o.ManualAccountNumber = &v
}

// GetRelationships returns the Relationships field value if set, zero value otherwise.
func (o *AccountCreation) GetRelationships() []AccountRelationship {
	if o == nil || IsNil(o.Relationships) {
		var ret []AccountRelationship
		return ret
	}
...
// SetRelationships gets a reference to the given []AccountRelationship and assigns it to the Relationships field.
...
func (o AccountCreation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ManualAccountNumber) {
		toSerialize["manual_account_number"] = o.ManualAccountNumber
	}
