...
type ApiCreateCashAuthorizationRequest struct {
	...
	body           *CashOrderAuthorizationPost
}
...
func (r ApiCreateCashAuthorizationRequest) Body(body CashOrderAuthorizationPost) ApiCreateCashAuthorizationRequest {
	r.body = &body
	return r
}

func (r ApiCreateCashAuthorizationRequest) Execute() (*CashOrderAuthorizationResponse, *http.Response, error) {
...
func (a *CashOrdersAndDepositsAlphaAPIService) CreateCashAuthorizationExecute(r ApiCreateCashAuthorizationRequest) (*CashOrderAuthorizationResponse, *http.Response, error) {
	var (
