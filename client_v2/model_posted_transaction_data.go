...
type PostedTransactionData struct {
	...
	VendorInfo           *TransactionVendorInfo `json:"vendor_info,omitempty"`
...
// SetVendorInfo gets a reference to the given TransactionVendorInfo and assigns it to the VendorInfo field.
