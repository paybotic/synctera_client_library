...
type EddCustomerResponse struct {
	...
	PepClassification  *PepClassification `json:"pep_classification,omitempty"`
...
// GetPepClassification returns the PepClassification field value if set, zero value otherwise.
func (o *EddCustomerResponse) GetPepClassification() PepClassification {
	if o == nil || IsNil(o.PepClassification) {
		var ret PepClassification
		return ret
	}
	return *o.PepClassification
}

// GetPepClassificationOk returns a tuple with the PepClassification field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EddCustomerResponse) GetPepClassificationOk() (*PepClassification, bool) {
	if o == nil || IsNil(o.PepClassification) {
		return nil, false
	}
	return o.PepClassification, true
}
...
// SetPepClassification gets a reference to the given PepClassification and assigns it to the PepClassification field.
func (o *EddCustomerResponse) SetPepClassification(v PepClassification) {
	o.PepClassification = &v
}
...
func (o EddCustomerResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PepClassification) {
		toSerialize["pep_classification"] = o.PepClassification
	}
...
func (o *EddCustomerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = EddCustomerResponse(varEddCustomerResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "pep_classification")
