...
type CardProduct struct {
	...
	BulkShippingEnabled *bool `json:"bulk_shipping_enabled,omitempty"`
	...
	UnsecuredCreditEnabled *bool `json:"unsecured_credit_enabled,omitempty"`
...
// GetBulkShippingEnabled returns the BulkShippingEnabled field value if set, zero value otherwise.
func (o *CardProduct) GetBulkShippingEnabled() bool {
	if o == nil || IsNil(o.BulkShippingEnabled) {
		var ret bool
		return ret
	}
...
// GetBulkShippingEnabledOk returns a tuple with the BulkShippingEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetBulkShippingEnabled gets a reference to the given bool and assigns it to the BulkShippingEnabled field.
...
// GetUnsecuredCreditEnabled returns the UnsecuredCreditEnabled field value if set, zero value otherwise.
func (o *CardProduct) GetUnsecuredCreditEnabled() bool {
	if o == nil || IsNil(o.UnsecuredCreditEnabled) {
		var ret bool
		return ret
	}
...
// GetUnsecuredCreditEnabledOk returns a tuple with the UnsecuredCreditEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetUnsecuredCreditEnabled gets a reference to the given bool and assigns it to the UnsecuredCreditEnabled field.
...
func (o CardProduct) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BulkShippingEnabled) {
	...
	if !IsNil(o.UnsecuredCreditEnabled) {
