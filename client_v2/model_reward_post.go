...
// checks if the RewardPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RewardPost{}

// RewardPost struct for RewardPost
...
func (o RewardPost) MarshalJSON() ([]byte, error) {
...
func (o RewardPost) ToMap() (map[string]interface{}, error) {
...
func (o *RewardPost) UnmarshalJSON(data []byte) (err error) {
	...
	varRewardPost := _RewardPost{}

	err = json.Unmarshal(data, &varRewardPost)

	if err != nil {
		return err
	}

	*o = RewardPost(varRewardPost)
...
type NullableRewardPost struct {
	value *RewardPost
	isSet bool
}

func (v NullableRewardPost) Get() *RewardPost {
	return v.value
}

func (v *NullableRewardPost) Set(val *RewardPost) {
	v.value = val
	v.isSet = true
}

func (v NullableRewardPost) IsSet() bool {
	return v.isSet
}

func (v *NullableRewardPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRewardPost(val *RewardPost) *NullableRewardPost {
	return &NullableRewardPost{value: val, isSet: true}
}

func (v NullableRewardPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRewardPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
