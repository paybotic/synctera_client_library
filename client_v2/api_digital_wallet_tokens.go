...
// Request to provision digital wallet card data to pass to Apple Pay digital wallet.  NB: Cannot be used outside of production.
...
// Card ID
func (r ApiCreateDigitalWalletAppleRequest) CardId(cardId string) ApiCreateDigitalWalletAppleRequest {
	r.cardId = &cardId
	return r
}
...
*/
func (a *DigitalWalletTokensAPIService) CreateDigitalWalletApple(ctx context.Context) ApiCreateDigitalWalletAppleRequest {
	return ApiCreateDigitalWalletAppleRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Request to provision digital wallet card data to pass to Google Pay digital wallet.  NB: Cannot be used outside of production.
...
// Card ID
func (r ApiCreateDigitalWalletGoogleRequest) CardId(cardId string) ApiCreateDigitalWalletGoogleRequest {
	r.cardId = &cardId
	return r
}
...
*/
func (a *DigitalWalletTokensAPIService) CreateDigitalWalletGoogle(ctx context.Context) ApiCreateDigitalWalletGoogleRequest {
	return ApiCreateDigitalWalletGoogleRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DigitalWalletTokensAPIService) ListDigitalWalletTokensExecute(r ApiListDigitalWalletTokensRequest) (*TokenListResponse, *http.Response, error) {
	...
	if r.tokenState != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "token_state", r.tokenState, "form", "")
	}
	if r.limit != nil {
