...
func (r ApiGetPendingTransactionByIDRequest) Id(id []string) ApiGetPendingTransactionByIDRequest {
	r.id = &id
	return r
}
...
*/
func (a *TransactionsAPIService) GetPendingTransactionByID(ctx context.Context) ApiGetPendingTransactionByIDRequest {
	return ApiGetPendingTransactionByIDRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Unique resource identifier
func (r ApiGetPostedTransactionByIDRequest) Id(id []string) ApiGetPostedTransactionByIDRequest {
	r.id = &id
	return r
}
...
*/
func (a *TransactionsAPIService) GetPostedTransactionByID(ctx context.Context) ApiGetPostedTransactionByIDRequest {
	return ApiGetPostedTransactionByIDRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (r ApiListPendingTransactionsRequest) UuidNin(uuidNin []string) ApiListPendingTransactionsRequest {
	r.uuidNin = &uuidNin
	return r
}
...
func (r ApiListPendingTransactionsRequest) DigitalWalletTokenId(digitalWalletTokenId []string) ApiListPendingTransactionsRequest {
	r.digitalWalletTokenId = &digitalWalletTokenId
	return r
}
...
func (r ApiListPendingTransactionsRequest) Type_(type_ []DocumentType) ApiListPendingTransactionsRequest {
	r.type_ = &type_
	return r
}
...
func (r ApiListPendingTransactionsRequest) Cashback(cashback bool) ApiListPendingTransactionsRequest {
	r.cashback = &cashback
	return r
}
...
func (r ApiListPendingTransactionsRequest) Amount(amount int32) ApiListPendingTransactionsRequest {
	r.amount = &amount
	return r
}
...
func (r ApiListPendingTransactionsRequest) TotalAmount(totalAmount int64) ApiListPendingTransactionsRequest {
...
func (a *TransactionsAPIService) ListPendingTransactionsExecute(r ApiListPendingTransactionsRequest) (*PendingTransactions, *http.Response, error) {
	...
	if r.uuidNin != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "uuid_nin", r.uuidNin, "form", "csv")
	}
	...
	if r.digitalWalletTokenId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "digital_wallet_token_id", r.digitalWalletTokenId, "form", "csv")
	}
	if r.fromDate != nil {
	...
	if r.cashback != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cashback", r.cashback, "form", "")
	}
	...
	if r.totalAmount != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "total_amount", r.totalAmount, "form", "")
	}
	if r.limit != nil {
...
// Transaction UUID(s) to exclude from the query. Multiple UUIDs can be provided as a comma-separated list.
func (r ApiListPostedTransactionsRequest) UuidNin(uuidNin []string) ApiListPostedTransactionsRequest {
	r.uuidNin = &uuidNin
	return r
}
...
// Digital Wallet token ID(s). Multiple IDs can be provided as a comma-separated list.
func (r ApiListPostedTransactionsRequest) DigitalWalletTokenId(digitalWalletTokenId []string) ApiListPostedTransactionsRequest {
	r.digitalWalletTokenId = &digitalWalletTokenId
	return r
}
...
// The type of documents. Multiple types can be provided as a comma-separated list.
func (r ApiListPostedTransactionsRequest) Type_(type_ []DocumentType) ApiListPostedTransactionsRequest {
	r.type_ = &type_
	return r
}
...
// If true, only transactions with cashback will be returned. If false, only transactions without cashback will be returned. If not provided, all transactions will be returned.
func (r ApiListPostedTransactionsRequest) Cashback(cashback bool) ApiListPostedTransactionsRequest {
	r.cashback = &cashback
	return r
}
...
// Only return transactions equal to the given &#x60;amount&#x60;
func (r ApiListPostedTransactionsRequest) Amount(amount int32) ApiListPostedTransactionsRequest {
	r.amount = &amount
	return r
}
