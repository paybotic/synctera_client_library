...
type FulfillmentDetails struct {
	...
	BulkOrderId *string `json:"bulk_order_id,omitempty"`
...
// GetBulkOrderId returns the BulkOrderId field value if set, zero value otherwise.
func (o *FulfillmentDetails) GetBulkOrderId() string {
	if o == nil || IsNil(o.BulkOrderId) {
		var ret string
		return ret
	}
	return *o.BulkOrderId
}

// GetBulkOrderIdOk returns a tuple with the BulkOrderId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FulfillmentDetails) GetBulkOrderIdOk() (*string, bool) {
	if o == nil || IsNil(o.BulkOrderId) {
		return nil, false
	}
	return o.BulkOrderId, true
}
...
// SetBulkOrderId gets a reference to the given string and assigns it to the BulkOrderId field.
...
func (o FulfillmentDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BulkOrderId) {
		toSerialize["bulk_order_id"] = o.BulkOrderId
	}
	if !IsNil(o.ShipDate) {
...
func (o *FulfillmentDetails) UnmarshalJSON(data []byte) (err error) {
	...
	*o = FulfillmentDetails(varFulfillmentDetails)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "bulk_order_id")
