...
const (
	...
	EVENTTYPEWILDCARD_SPEND_CONTROL          EventTypeWildcard = "SPEND_CONTROL.*"
	EVENTTYPEWILDCARD_EDD                    EventTypeWildcard = "EDD.*"
	EVENTTYPEWILDCARD_CRR                    EventTypeWildcard = "CRR.*"
	EVENTTYPEWILDCARD_DOCUMENT               EventTypeWildcard = "DOCUMENT.*"
)
