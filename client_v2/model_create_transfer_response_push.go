...
// checks if the CreateTransferResponsePush type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTransferResponsePush{}

// CreateTransferResponsePush Push funds to an External Card
type CreateTransferResponsePush struct {
...
type _CreateTransferResponsePush CreateTransferResponsePush
...
func NewCreateTransferResponsePush(accountId string, amount int32, creationTime time.Time, currency string, customerId string, id string, lastUpdatedTime time.Time, merchant Merchant, status TransferStatus, tenant string, externalCardId string, type_ CreateTransferType) *CreateTransferResponsePush {
	this := CreateTransferResponsePush{}
...
func (o CreateTransferResponsePush) MarshalJSON() ([]byte, error) {
...
func (o CreateTransferResponsePush) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTransferResponsePush) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTransferResponsePush := _CreateTransferResponsePush{}

	err = json.Unmarshal(data, &varCreateTransferResponsePush)

	if err != nil {
		return err
	}

	*o = CreateTransferResponsePush(varCreateTransferResponsePush)
...
type NullableCreateTransferResponsePush struct {
	value *CreateTransferResponsePush
	isSet bool
}

func (v NullableCreateTransferResponsePush) Get() *CreateTransferResponsePush {
	return v.value
}

func (v *NullableCreateTransferResponsePush) Set(val *CreateTransferResponsePush) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTransferResponsePush) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTransferResponsePush) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTransferResponsePush(val *CreateTransferResponsePush) *NullableCreateTransferResponsePush {
	return &NullableCreateTransferResponsePush{value: val, isSet: true}
}

func (v NullableCreateTransferResponsePush) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTransferResponsePush) UnmarshalJSON(src []byte) error {
	v.isSet = true
