...
type ApiInitiateDocumentVerificationSessionRequest struct {
	ctx                                context.Context
	ApiService                         *KYCKYBVerificationsAPIService
	documentVerificationSessionRequest *DocumentVerificationSessionRequest
	idempotencyKey                     *string
}

func (r ApiInitiateDocumentVerificationSessionRequest) DocumentVerificationSessionRequest(documentVerificationSessionRequest DocumentVerificationSessionRequest) ApiInitiateDocumentVerificationSessionRequest {
	r.documentVerificationSessionRequest = &documentVerificationSessionRequest
	return r
}

// An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
func (r ApiInitiateDocumentVerificationSessionRequest) IdempotencyKey(idempotencyKey string) ApiInitiateDocumentVerificationSessionRequest {
	r.idempotencyKey = &idempotencyKey
	return r
}

func (r ApiInitiateDocumentVerificationSessionRequest) Execute() (*DocumentVerificationSessionResponse, *http.Response, error) {
	return r.ApiService.InitiateDocumentVerificationSessionExecute(r)
}

/*
InitiateDocumentVerificationSession Initiate Document Verification Session

Initiate document verification session to be used with `/verifications/verify`.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiInitiateDocumentVerificationSessionRequest
*/
func (a *KYCKYBVerificationsAPIService) InitiateDocumentVerificationSession(ctx context.Context) ApiInitiateDocumentVerificationSessionRequest {
	return ApiInitiateDocumentVerificationSessionRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return DocumentVerificationSessionResponse
func (a *KYCKYBVerificationsAPIService) InitiateDocumentVerificationSessionExecute(r ApiInitiateDocumentVerificationSessionRequest) (*DocumentVerificationSessionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DocumentVerificationSessionResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KYCKYBVerificationsAPIService.InitiateDocumentVerificationSession")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/verifications/docv_session"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.documentVerificationSessionRequest == nil {
		return localVarReturnValue, nil, reportError("documentVerificationSessionRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.documentVerificationSessionRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiListVerifications1Request) Uuid(uuid []string) ApiListVerifications1Request {
	r.uuid = &uuid
	return r
}
