...
// checks if the PatchAccountRevolvingCreditUnsecured type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchAccountRevolvingCreditUnsecured{}

// PatchAccountRevolvingCreditUnsecured struct for PatchAccountRevolvingCreditUnsecured
type PatchAccountRevolvingCreditUnsecured struct {
	...
	// The credit limit for this revolving credit unsecured account in cents. Minimum is 0.
	CreditLimit *int64 `json:"credit_limit,omitempty"`
	// Add an optional note when patching a revolving credit unsecured account. A note is required when setting the status to or from SUSPENDED.
...
type _PatchAccountRevolvingCreditUnsecured PatchAccountRevolvingCreditUnsecured
...
func NewPatchAccountRevolvingCreditUnsecured() *PatchAccountRevolvingCreditUnsecured {
	this := PatchAccountRevolvingCreditUnsecured{}
	return &this
}
...
func (o PatchAccountRevolvingCreditUnsecured) MarshalJSON() ([]byte, error) {
...
func (o PatchAccountRevolvingCreditUnsecured) ToMap() (map[string]interface{}, error) {
...
func (o *PatchAccountRevolvingCreditUnsecured) UnmarshalJSON(data []byte) (err error) {
	varPatchAccountRevolvingCreditUnsecured := _PatchAccountRevolvingCreditUnsecured{}

	err = json.Unmarshal(data, &varPatchAccountRevolvingCreditUnsecured)

	if err != nil {
		return err
	}

	*o = PatchAccountRevolvingCreditUnsecured(varPatchAccountRevolvingCreditUnsecured)
...
type NullablePatchAccountRevolvingCreditUnsecured struct {
	value *PatchAccountRevolvingCreditUnsecured
	isSet bool
}

func (v NullablePatchAccountRevolvingCreditUnsecured) Get() *PatchAccountRevolvingCreditUnsecured {
	return v.value
}

func (v *NullablePatchAccountRevolvingCreditUnsecured) Set(val *PatchAccountRevolvingCreditUnsecured) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchAccountRevolvingCreditUnsecured) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchAccountRevolvingCreditUnsecured) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchAccountRevolvingCreditUnsecured(val *PatchAccountRevolvingCreditUnsecured) *NullablePatchAccountRevolvingCreditUnsecured {
	return &NullablePatchAccountRevolvingCreditUnsecured{value: val, isSet: true}
}

func (v NullablePatchAccountRevolvingCreditUnsecured) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchAccountRevolvingCreditUnsecured) UnmarshalJSON(src []byte) error {
	v.isSet = true
