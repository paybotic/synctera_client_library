...
// AccountType The type of the account. In lead mode, this always takes the value of the template. If not specified in shadow mode, CHECKING will be assumed. Below mentioned are the account types: * SAVING: Savings account * CHECKING: Checking account * PREPAID: Prepaid account * LINE_OF_CREDIT: Line of Credit account * CHARGE_SECURED: Secured Charge account, e.g. for use in a Smart Charge Card offering * CHARGE_UNSECURED: (alpha) Unsecured Charge account * REVOLVING_CREDIT_SECURED: Secured Revolving Credit account * REVOLVING_CREDIT_UNSECURED: Unsecured Revolving Credit account * GENERAL_LEDGER: General Ledger account (alpha - cannot yet be created). In production, these can only be created or updated by a Synctera administrator.
...
const (
	...
	ACCOUNTTYPE_PREPAID                    AccountType = "PREPAID"
	ACCOUNTTYPE_LINE_OF_CREDIT             AccountType = "LINE_OF_CREDIT"
	ACCOUNTTYPE_CHARGE_SECURED             AccountType = "CHARGE_SECURED"
	ACCOUNTTYPE_CHARGE_UNSECURED           AccountType = "CHARGE_UNSECURED"
	ACCOUNTTYPE_REVOLVING_CREDIT_SECURED   AccountType = "REVOLVING_CREDIT_SECURED"
	ACCOUNTTYPE_REVOLVING_CREDIT_UNSECURED AccountType = "REVOLVING_CREDIT_UNSECURED"
	ACCOUNTTYPE_GENERAL_LEDGER             AccountType = "GENERAL_LEDGER"
)
