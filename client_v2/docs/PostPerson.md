...
`func (o *PostPerson) GetCustomerActive() time.Time`

GetCustomerActive returns the CustomerActive field if non-nil, zero value otherwise.

### GetCustomerActiveOk

`func (o *PostPerson) GetCustomerActiveOk() (*time.Time, bool)`
...
`func (o *PostPerson) SetCustomerActive(v time.Time)`

SetCustomerActive sets CustomerActive field to given value.

### HasCustomerActive

`func (o *PostPerson) HasCustomerActive() bool`
