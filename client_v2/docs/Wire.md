...
**FedInputMessageAccountabilityData** | Pointer to **string** | The Synctera-generated IMAD can be overwritten when the wire is uploaded to the FED. If that happens and we are provided with the new IMAD, it will be populated in this field. | [optional] 
...
### GetFedInputMessageAccountabilityData

`func (o *Wire) GetFedInputMessageAccountabilityData() string`

GetFedInputMessageAccountabilityData returns the FedInputMessageAccountabilityData field if non-nil, zero value otherwise.

### GetFedInputMessageAccountabilityDataOk

`func (o *Wire) GetFedInputMessageAccountabilityDataOk() (*string, bool)`

GetFedInputMessageAccountabilityDataOk returns a tuple with the FedInputMessageAccountabilityData field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetFedInputMessageAccountabilityData

`func (o *Wire) SetFedInputMessageAccountabilityData(v string)`

SetFedInputMessageAccountabilityData sets FedInputMessageAccountabilityData field to given value.

### HasFedInputMessageAccountabilityData

`func (o *Wire) HasFedInputMessageAccountabilityData() bool`

HasFedInputMessageAccountabilityData returns a boolean if a field has been set.
