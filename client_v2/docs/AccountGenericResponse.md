...
**AccountClosure** | Pointer to [**AccountClosureResponse**](AccountClosureResponse.md) |  | [optional] 
...
**InClosingDate** | Pointer to **string** | The account in-closing date. This is the bank&#39;s posting date when the account resource&#39;s status was changed to IN_CLOSING. | [optional] [readonly] 
...
**VendorInfo** | Pointer to [**VendorInfoResponse**](VendorInfoResponse.md) |  | [optional] 
...
`func (o *AccountGenericResponse) GetAccountClosure() AccountClosureResponse`

GetAccountClosure returns the AccountClosure field if non-nil, zero value otherwise.

### GetAccountClosureOk

`func (o *AccountGenericResponse) GetAccountClosureOk() (*AccountClosureResponse, bool)`
...
`func (o *AccountGenericResponse) SetAccountClosure(v AccountClosureResponse)`
...
`func (o *AccountGenericResponse) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *AccountGenericResponse) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *AccountGenericResponse) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *AccountGenericResponse) HasAccountProgramId() bool`
...
`func (o *AccountGenericResponse) GetInClosingDate() string`

GetInClosingDate returns the InClosingDate field if non-nil, zero value otherwise.

### GetInClosingDateOk

`func (o *AccountGenericResponse) GetInClosingDateOk() (*string, bool)`

GetInClosingDateOk returns a tuple with the InClosingDate field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetInClosingDate

`func (o *AccountGenericResponse) SetInClosingDate(v string)`

SetInClosingDate sets InClosingDate field to given value.

### HasInClosingDate

`func (o *AccountGenericResponse) HasInClosingDate() bool`

HasInClosingDate returns a boolean if a field has been set.
...
`func (o *AccountGenericResponse) GetVendorInfo() VendorInfoResponse`

GetVendorInfo returns the VendorInfo field if non-nil, zero value otherwise.

### GetVendorInfoOk

`func (o *AccountGenericResponse) GetVendorInfoOk() (*VendorInfoResponse, bool)`
...
`func (o *AccountGenericResponse) SetVendorInfo(v VendorInfoResponse)`

SetVendorInfo sets VendorInfo field to given value.

### HasVendorInfo

`func (o *AccountGenericResponse) HasVendorInfo() bool`
