...
`func (o *PatchPerson) GetCustomerActive() time.Time`

GetCustomerActive returns the CustomerActive field if non-nil, zero value otherwise.

### GetCustomerActiveOk

`func (o *PatchPerson) GetCustomerActiveOk() (*time.Time, bool)`
...
`func (o *PatchPerson) SetCustomerActive(v time.Time)`

SetCustomerActive sets CustomerActive field to given value.

### HasCustomerActive

`func (o *PatchPerson) HasCustomerActive() bool`
...
`func (o *PatchPerson) GetVendorInfo() PartyVendorInfo`

GetVendorInfo returns the VendorInfo field if non-nil, zero value otherwise.

### GetVendorInfoOk

`func (o *PatchPerson) GetVendorInfoOk() (*PartyVendorInfo, bool)`
...
`func (o *PatchPerson) SetVendorInfo(v PartyVendorInfo)`

SetVendorInfo sets VendorInfo field to given value.

### HasVendorInfo

`func (o *PatchPerson) HasVendorInfo() bool`
