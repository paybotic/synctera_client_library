...
`func (o *PendingTransaction) GetEnhancedTransaction() map[string]interface{}`

GetEnhancedTransaction returns the EnhancedTransaction field if non-nil, zero value otherwise.

### GetEnhancedTransactionOk

`func (o *PendingTransaction) GetEnhancedTransactionOk() (*map[string]interface{}, bool)`
...
`func (o *PendingTransaction) SetEnhancedTransaction(v map[string]interface{})`

SetEnhancedTransaction sets EnhancedTransaction field to given value.

### HasEnhancedTransaction

`func (o *PendingTransaction) HasEnhancedTransaction() bool`
