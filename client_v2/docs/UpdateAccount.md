...
`func (o *UpdateAccount) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *UpdateAccount) HasAccountProgramId() bool`
