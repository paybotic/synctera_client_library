...
func main() {
	relationshipIn := openapiclient.relationship_in{BusinessBusinessOwnerRelationship: openapiclient.NewBusinessBusinessOwnerRelationship(openapiclient.relationship_types("BENEFICIAL_OWNER_OF"))} // RelationshipIn | Party relationship to create.
