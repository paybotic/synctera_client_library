...
**PepClassification** | Pointer to [**PepClassification**](PepClassification.md) |  | [optional] 
...
`func NewEddCustomerResponse(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, creationTime time.Time, deletionTime NullableTime, id string, ) *EddCustomerResponse`
...
`func (o *EddCustomerResponse) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *EddCustomerResponse) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *EddCustomerResponse) SetRelatedResourceType(v RelatedResourceType)`
...
### GetPepClassification

`func (o *EddCustomerResponse) GetPepClassification() PepClassification`

GetPepClassification returns the PepClassification field if non-nil, zero value otherwise.

### GetPepClassificationOk

`func (o *EddCustomerResponse) GetPepClassificationOk() (*PepClassification, bool)`

GetPepClassificationOk returns a tuple with the PepClassification field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetPepClassification

`func (o *EddCustomerResponse) SetPepClassification(v PepClassification)`

SetPepClassification sets PepClassification field to given value.

### HasPepClassification

`func (o *EddCustomerResponse) HasPepClassification() bool`

HasPepClassification returns a boolean if a field has been set.
