...
**StatusReason** | Pointer to **string** | The reason for the status for the external account. | [optional] 
...
**VendorInfo** | Pointer to [**VendorInfo2**](VendorInfo2.md) |  | [optional] 
...
`func (o *ExternalAccount) GetStatusReason() string`

GetStatusReason returns the StatusReason field if non-nil, zero value otherwise.

### GetStatusReasonOk

`func (o *ExternalAccount) GetStatusReasonOk() (*string, bool)`
...
`func (o *ExternalAccount) SetStatusReason(v string)`

SetStatusReason sets StatusReason field to given value.

### HasStatusReason

`func (o *ExternalAccount) HasStatusReason() bool`
...
`func (o *ExternalAccount) GetVendorInfo() VendorInfo2`

GetVendorInfo returns the VendorInfo field if non-nil, zero value otherwise.

### GetVendorInfoOk

`func (o *ExternalAccount) GetVendorInfoOk() (*VendorInfo2, bool)`
...
`func (o *ExternalAccount) SetVendorInfo(v VendorInfo2)`
