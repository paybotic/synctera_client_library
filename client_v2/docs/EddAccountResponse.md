...
`func NewEddAccountResponse(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, creationTime time.Time, deletionTime NullableTime, id string, ) *EddAccountResponse`
...
`func (o *EddAccountResponse) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *EddAccountResponse) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *EddAccountResponse) SetRelatedResourceType(v RelatedResourceType)`
