...
`func (o *AccountGeneralLedger) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *AccountGeneralLedger) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *AccountGeneralLedger) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *AccountGeneralLedger) HasAccountProgramId() bool`
