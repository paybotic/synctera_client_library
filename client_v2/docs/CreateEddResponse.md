...
`func NewCreateEddResponse(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, creationTime time.Time, deletionTime NullableTime, id string, ) *CreateEddResponse`
...
`func (o *CreateEddResponse) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *CreateEddResponse) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *CreateEddResponse) SetRelatedResourceType(v RelatedResourceType)`
...
`func (o *CreateEddResponse) GetPepClassification() PepClassification`

GetPepClassification returns the PepClassification field if non-nil, zero value otherwise.

### GetPepClassificationOk

`func (o *CreateEddResponse) GetPepClassificationOk() (*PepClassification, bool)`
...
`func (o *CreateEddResponse) SetPepClassification(v PepClassification)`

SetPepClassification sets PepClassification field to given value.

### HasPepClassification

`func (o *CreateEddResponse) HasPepClassification() bool`
