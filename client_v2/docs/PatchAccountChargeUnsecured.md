...
`func (o *PatchAccountChargeUnsecured) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *PatchAccountChargeUnsecured) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *PatchAccountChargeUnsecured) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *PatchAccountChargeUnsecured) HasAccountProgramId() bool`
