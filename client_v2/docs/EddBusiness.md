...
`func NewEddBusiness(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, ) *EddBusiness`
...
`func (o *EddBusiness) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *EddBusiness) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *EddBusiness) SetRelatedResourceType(v RelatedResourceType)`
