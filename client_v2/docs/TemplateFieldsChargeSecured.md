...
`func NewTemplateFieldsChargeSecured(accountType AccountType, bankCountry string, currency string, minimumPayment MinimumPaymentTypeFull, ) *TemplateFieldsChargeSecured`
...
`func (o *TemplateFieldsChargeSecured) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *TemplateFieldsChargeSecured) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *TemplateFieldsChargeSecured) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *TemplateFieldsChargeSecured) HasAccountProgramId() bool`
...
`func (o *TemplateFieldsChargeSecured) GetMinimumPayment() MinimumPaymentTypeFull`

GetMinimumPayment returns the MinimumPayment field if non-nil, zero value otherwise.

### GetMinimumPaymentOk

`func (o *TemplateFieldsChargeSecured) GetMinimumPaymentOk() (*MinimumPaymentTypeFull, bool)`
...
`func (o *TemplateFieldsChargeSecured) SetMinimumPayment(v MinimumPaymentTypeFull)`
