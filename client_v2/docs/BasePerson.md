...
`func (o *BasePerson) GetCustomerActive() time.Time`

GetCustomerActive returns the CustomerActive field if non-nil, zero value otherwise.

### GetCustomerActiveOk

`func (o *BasePerson) GetCustomerActiveOk() (*time.Time, bool)`
...
`func (o *BasePerson) SetCustomerActive(v time.Time)`

SetCustomerActive sets CustomerActive field to given value.

### HasCustomerActive

`func (o *BasePerson) HasCustomerActive() bool`
