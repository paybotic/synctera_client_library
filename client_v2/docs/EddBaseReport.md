...
`func NewEddBaseReport(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, ) *EddBaseReport`
...
`func (o *EddBaseReport) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *EddBaseReport) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *EddBaseReport) SetRelatedResourceType(v RelatedResourceType)`
