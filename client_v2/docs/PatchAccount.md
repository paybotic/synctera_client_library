...
`func (o *PatchAccount) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *PatchAccount) HasAccountProgramId() bool`
...
`func (o *PatchAccount) GetMinimumPayment() MinimumPaymentTypeRateOrAmount`

GetMinimumPayment returns the MinimumPayment field if non-nil, zero value otherwise.

### GetMinimumPaymentOk

`func (o *PatchAccount) GetMinimumPaymentOk() (*MinimumPaymentTypeRateOrAmount, bool)`
...
`func (o *PatchAccount) SetMinimumPayment(v MinimumPaymentTypeRateOrAmount)`
...
`func (o *PatchAccount) GetVendorInfo() VendorInfoPatch`

GetVendorInfo returns the VendorInfo field if non-nil, zero value otherwise.

### GetVendorInfoOk

`func (o *PatchAccount) GetVendorInfoOk() (*VendorInfoPatch, bool)`
...
`func (o *PatchAccount) SetVendorInfo(v VendorInfoPatch)`

SetVendorInfo sets VendorInfo field to given value.

### HasVendorInfo

`func (o *PatchAccount) HasVendorInfo() bool`
