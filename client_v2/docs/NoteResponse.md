...
`func NewNoteResponse(author string, content string, creationTime time.Time, id string, lastUpdatedTime time.Time, relatedResourceId string, relatedResourceType RelatedResourceType, tenant string, ) *NoteResponse`
...
`func (o *NoteResponse) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *NoteResponse) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *NoteResponse) SetRelatedResourceType(v RelatedResourceType)`
