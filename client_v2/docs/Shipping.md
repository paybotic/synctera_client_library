...
------------ | ------------- | ------------- | -------------
**Address** | Pointer to [**Address**](Address.md) | The address to which the card will be shipped - Defaults to account shipping address if none supplied | [optional] 
...
**Method** | Pointer to [**ShippingMethod**](ShippingMethod.md) |  | [optional] 
**PhoneNumber** | Pointer to **string** | The phone number of the recipient | [optional] 
**RecipientName** | Pointer to [**RecipientName**](RecipientName.md) | The name of the recipient to whom the card will be shipped | [optional] 
...
`func (o *Shipping) GetMethod() ShippingMethod`

GetMethod returns the Method field if non-nil, zero value otherwise.

### GetMethodOk

`func (o *Shipping) GetMethodOk() (*ShippingMethod, bool)`
...
`func (o *Shipping) SetMethod(v ShippingMethod)`
