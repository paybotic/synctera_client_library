...
`func (o *PaymentSchedule) GetTenant() string`

GetTenant returns the Tenant field if non-nil, zero value otherwise.

### GetTenantOk

`func (o *PaymentSchedule) GetTenantOk() (*string, bool)`
...
`func (o *PaymentSchedule) SetTenant(v string)`

SetTenant sets Tenant field to given value.

### HasTenant

`func (o *PaymentSchedule) HasTenant() bool`
