...
`func (o *AccountChargeSecured) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *AccountChargeSecured) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *AccountChargeSecured) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *AccountChargeSecured) HasAccountProgramId() bool`
