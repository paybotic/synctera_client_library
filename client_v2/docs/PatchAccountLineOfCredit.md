...
`func (o *PatchAccountLineOfCredit) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *PatchAccountLineOfCredit) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *PatchAccountLineOfCredit) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *PatchAccountLineOfCredit) HasAccountProgramId() bool`
...
`func (o *PatchAccountLineOfCredit) GetMinimumPayment() MinimumPaymentTypeRateOrAmount`

GetMinimumPayment returns the MinimumPayment field if non-nil, zero value otherwise.

### GetMinimumPaymentOk

`func (o *PatchAccountLineOfCredit) GetMinimumPaymentOk() (*MinimumPaymentTypeRateOrAmount, bool)`
...
`func (o *PatchAccountLineOfCredit) SetMinimumPayment(v MinimumPaymentTypeRateOrAmount)`
