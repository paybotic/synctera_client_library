...
`func NewEddBusinessResponse(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, creationTime time.Time, deletionTime NullableTime, id string, ) *EddBusinessResponse`
...
`func (o *EddBusinessResponse) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *EddBusinessResponse) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *EddBusinessResponse) SetRelatedResourceType(v RelatedResourceType)`
