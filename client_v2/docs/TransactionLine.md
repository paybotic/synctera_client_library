...
**RelatedLine** | **int32** |  | 
**Seq** | **int32** |  | 
**SweepAggId** | Pointer to **string** | The sweep aggregation that this line is mapped to. | [optional] 
...
GetSweepAggId returns the SweepAggId field if non-nil, zero value otherwise.

### GetSweepAggIdOk

`func (o *TransactionLine) GetSweepAggIdOk() (*string, bool)`

GetSweepAggIdOk returns a tuple with the SweepAggId field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetSweepAggId sets SweepAggId field to given value.
