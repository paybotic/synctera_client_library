...
`func (o *PatchAccountGeneralLedger) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *PatchAccountGeneralLedger) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *PatchAccountGeneralLedger) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *PatchAccountGeneralLedger) HasAccountProgramId() bool`
