...
`func (o *PostedTransaction) GetEnhancedTransaction() map[string]interface{}`

GetEnhancedTransaction returns the EnhancedTransaction field if non-nil, zero value otherwise.

### GetEnhancedTransactionOk

`func (o *PostedTransaction) GetEnhancedTransactionOk() (*map[string]interface{}, bool)`
...
`func (o *PostedTransaction) SetEnhancedTransaction(v map[string]interface{})`

SetEnhancedTransaction sets EnhancedTransaction field to given value.

### HasEnhancedTransaction

`func (o *PostedTransaction) HasEnhancedTransaction() bool`
