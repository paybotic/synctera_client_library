...
**AmountLimit** | Pointer to **NullableInt64** | Monetary limit for the spend control in the smallest currency unit (eg cents) | [optional] 
**Direction** | Pointer to [**SpendControlDirection**](SpendControlDirection.md) |  | [optional] 
**GeoRestrictions** | Pointer to [**NullableSpendControlGeoRestrictions**](SpendControlGeoRestrictions.md) |  | [optional] 
...
**TransactionCountLimit** | Pointer to **NullableInt64** | Number of transactions allowed by the spend control, regardless of transaction amounts. | [optional] 
...
`func (o *SpendControlUpdateRequest) SetAmountLimitNil(b bool)`
...
### SetGeoRestrictionsNil

`func (o *SpendControlUpdateRequest) SetGeoRestrictionsNil(b bool)`

 SetGeoRestrictionsNil sets the value for GeoRestrictions to be an explicit nil

### UnsetGeoRestrictions
...
### SetTransactionCountLimitNil

`func (o *SpendControlUpdateRequest) SetTransactionCountLimitNil(b bool)`

 SetTransactionCountLimitNil sets the value for TransactionCountLimit to be an explicit nil

### UnsetTransactionCountLimit
