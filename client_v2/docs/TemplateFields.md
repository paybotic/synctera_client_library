...
**MinimumPayment** | [**MinimumPaymentTypeFull**](MinimumPaymentTypeFull.md) |  | 
...
`func NewTemplateFields(accountType AccountType, bankCountry string, currency string, minimumPayment MinimumPaymentTypeFull, applicationWorkflowId string, vendorInfo TemplateVendorInfo, ) *TemplateFields`
...
`func (o *TemplateFields) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *TemplateFields) HasAccountProgramId() bool`
...
`func (o *TemplateFields) GetMinimumPayment() MinimumPaymentTypeFull`

GetMinimumPayment returns the MinimumPayment field if non-nil, zero value otherwise.

### GetMinimumPaymentOk

`func (o *TemplateFields) GetMinimumPaymentOk() (*MinimumPaymentTypeFull, bool)`
...
`func (o *TemplateFields) SetMinimumPayment(v MinimumPaymentTypeFull)`
...
`func (o *TemplateFields) GetApplicationWorkflowId() string`
...
`func (o *TemplateFields) GetApplicationWorkflowIdOk() (*string, bool)`
...
`func (o *TemplateFields) SetApplicationWorkflowId(v string)`
...
`func (o *TemplateFields) GetVendorInfo() TemplateVendorInfo`

GetVendorInfo returns the VendorInfo field if non-nil, zero value otherwise.

### GetVendorInfoOk

`func (o *TemplateFields) GetVendorInfoOk() (*TemplateVendorInfo, bool)`
...
`func (o *TemplateFields) SetVendorInfo(v TemplateVendorInfo)`
