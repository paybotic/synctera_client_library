...
`func (o *PhysicalCardPlusStatus) GetLastUpdatedTime() time.Time`

GetLastUpdatedTime returns the LastUpdatedTime field if non-nil, zero value otherwise.

### GetLastUpdatedTimeOk

`func (o *PhysicalCardPlusStatus) GetLastUpdatedTimeOk() (*time.Time, bool)`
...
`func (o *PhysicalCardPlusStatus) SetLastUpdatedTime(v time.Time)`

SetLastUpdatedTime sets LastUpdatedTime field to given value.

### HasLastUpdatedTime

`func (o *PhysicalCardPlusStatus) HasLastUpdatedTime() bool`
...
`func (o *PhysicalCardPlusStatus) GetBulkOrderConfigId() string`

GetBulkOrderConfigId returns the BulkOrderConfigId field if non-nil, zero value otherwise.

### GetBulkOrderConfigIdOk

`func (o *PhysicalCardPlusStatus) GetBulkOrderConfigIdOk() (*string, bool)`
...
`func (o *PhysicalCardPlusStatus) SetBulkOrderConfigId(v string)`

SetBulkOrderConfigId sets BulkOrderConfigId field to given value.

### HasBulkOrderConfigId

`func (o *PhysicalCardPlusStatus) HasBulkOrderConfigId() bool`
