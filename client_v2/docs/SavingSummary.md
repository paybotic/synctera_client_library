...
------------ | ------------- | ------------- | -------------
**AccrualDays** | Pointer to **int32** | The number of days for which interest was accrued. In most cases this will match the number of days in the billing period, but may be less if an account was closed part way through the period.  | [optional] 
**Apy** | Pointer to **int32** | The annual percentage yield (APY) for this statement period, in basis points. For example, an APY of 5.5% will display as 550.  | [optional] 
