...
`func NewEddTransactionResponse(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, creationTime time.Time, deletionTime NullableTime, id string, ) *EddTransactionResponse`
...
`func (o *EddTransactionResponse) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *EddTransactionResponse) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *EddTransactionResponse) SetRelatedResourceType(v RelatedResourceType)`
