...
`func (o *AccountRelationship) GetOwnershipPercentage() float64`

GetOwnershipPercentage returns the OwnershipPercentage field if non-nil, zero value otherwise.

### GetOwnershipPercentageOk

`func (o *AccountRelationship) GetOwnershipPercentageOk() (*float64, bool)`
...
`func (o *AccountRelationship) SetOwnershipPercentage(v float64)`

SetOwnershipPercentage sets OwnershipPercentage field to given value.

### HasOwnershipPercentage

`func (o *AccountRelationship) HasOwnershipPercentage() bool`
