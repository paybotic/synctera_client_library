...
`func (o *TemplateFieldsGenericResponse) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *TemplateFieldsGenericResponse) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *TemplateFieldsGenericResponse) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *TemplateFieldsGenericResponse) HasAccountProgramId() bool`
...
`func (o *TemplateFieldsGenericResponse) GetApplicationWorkflowId() string`
...
`func (o *TemplateFieldsGenericResponse) GetApplicationWorkflowIdOk() (*string, bool)`
...
`func (o *TemplateFieldsGenericResponse) SetApplicationWorkflowId(v string)`

SetApplicationWorkflowId sets ApplicationWorkflowId field to given value.

### HasApplicationWorkflowId

`func (o *TemplateFieldsGenericResponse) HasApplicationWorkflowId() bool`
...
`func (o *TemplateFieldsGenericResponse) GetVendorInfo() TemplateVendorInfo`

GetVendorInfo returns the VendorInfo field if non-nil, zero value otherwise.

### GetVendorInfoOk

`func (o *TemplateFieldsGenericResponse) GetVendorInfoOk() (*TemplateVendorInfo, bool)`
...
`func (o *TemplateFieldsGenericResponse) SetVendorInfo(v TemplateVendorInfo)`

SetVendorInfo sets VendorInfo field to given value.

### HasVendorInfo

`func (o *TemplateFieldsGenericResponse) HasVendorInfo() bool`
