...
**VendorInfo** | Pointer to [**TransactionVendorInfo**](TransactionVendorInfo.md) |  | [optional] 

## Methods

### NewPostedTransactionData

`func NewPostedTransactionData(forcePost bool, lines []TransactionLine, memo string, metadata map[string]interface{}, ) *PostedTransactionData`
...
`func (o *PostedTransactionData) GetVendorInfo() TransactionVendorInfo`

GetVendorInfo returns the VendorInfo field if non-nil, zero value otherwise.

### GetVendorInfoOk

`func (o *PostedTransactionData) GetVendorInfoOk() (*TransactionVendorInfo, bool)`
...
`func (o *PostedTransactionData) SetVendorInfo(v TransactionVendorInfo)`

SetVendorInfo sets VendorInfo field to given value.

### HasVendorInfo

`func (o *PostedTransactionData) HasVendorInfo() bool`
