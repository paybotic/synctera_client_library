...
**PaymentSchedules** | [**[]PaymentScheduleResponse**](PaymentScheduleResponse.md) | Array of payment schedules. | 

## Methods

### NewPaymentScheduleList

`func NewPaymentScheduleList(paymentSchedules []PaymentScheduleResponse, ) *PaymentScheduleList`
...
`func (o *PaymentScheduleList) GetPaymentSchedules() []PaymentScheduleResponse`

GetPaymentSchedules returns the PaymentSchedules field if non-nil, zero value otherwise.

### GetPaymentSchedulesOk

`func (o *PaymentScheduleList) GetPaymentSchedulesOk() (*[]PaymentScheduleResponse, bool)`
...
`func (o *PaymentScheduleList) SetPaymentSchedules(v []PaymentScheduleResponse)`
