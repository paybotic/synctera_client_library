...
`func (o *AccountDepository) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *AccountDepository) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *AccountDepository) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *AccountDepository) HasAccountProgramId() bool`
