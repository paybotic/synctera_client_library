...
`func (o *PatchAccountDepository) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *PatchAccountDepository) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *PatchAccountDepository) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *PatchAccountDepository) HasAccountProgramId() bool`
