...
`func (o *AccountLineOfCredit) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *AccountLineOfCredit) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *AccountLineOfCredit) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *AccountLineOfCredit) HasAccountProgramId() bool`
...
`func (o *AccountLineOfCredit) GetMinimumPayment() MinimumPaymentTypeRateOrAmount`

GetMinimumPayment returns the MinimumPayment field if non-nil, zero value otherwise.

### GetMinimumPaymentOk

`func (o *AccountLineOfCredit) GetMinimumPaymentOk() (*MinimumPaymentTypeRateOrAmount, bool)`
...
`func (o *AccountLineOfCredit) SetMinimumPayment(v MinimumPaymentTypeRateOrAmount)`
