...
`func NewCreateEddRequest(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, ) *CreateEddRequest`
...
`func (o *CreateEddRequest) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *CreateEddRequest) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *CreateEddRequest) SetRelatedResourceType(v RelatedResourceType)`
...
`func (o *CreateEddRequest) GetPepClassification() PepClassification`

GetPepClassification returns the PepClassification field if non-nil, zero value otherwise.

### GetPepClassificationOk

`func (o *CreateEddRequest) GetPepClassificationOk() (*PepClassification, bool)`
...
`func (o *CreateEddRequest) SetPepClassification(v PepClassification)`

SetPepClassification sets PepClassification field to given value.

### HasPepClassification

`func (o *CreateEddRequest) HasPepClassification() bool`
