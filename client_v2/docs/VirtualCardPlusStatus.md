...
`func (o *VirtualCardPlusStatus) GetLastUpdatedTime() time.Time`

GetLastUpdatedTime returns the LastUpdatedTime field if non-nil, zero value otherwise.

### GetLastUpdatedTimeOk

`func (o *VirtualCardPlusStatus) GetLastUpdatedTimeOk() (*time.Time, bool)`
...
`func (o *VirtualCardPlusStatus) SetLastUpdatedTime(v time.Time)`

SetLastUpdatedTime sets LastUpdatedTime field to given value.

### HasLastUpdatedTime

`func (o *VirtualCardPlusStatus) HasLastUpdatedTime() bool`
