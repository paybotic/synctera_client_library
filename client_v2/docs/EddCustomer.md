...
`func NewEddCustomer(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, ) *EddCustomer`
...
`func (o *EddCustomer) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *EddCustomer) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *EddCustomer) SetRelatedResourceType(v RelatedResourceType)`
...
`func (o *EddCustomer) GetPepClassification() PepClassification`

GetPepClassification returns the PepClassification field if non-nil, zero value otherwise.

### GetPepClassificationOk

`func (o *EddCustomer) GetPepClassificationOk() (*PepClassification, bool)`
...
`func (o *EddCustomer) SetPepClassification(v PepClassification)`

SetPepClassification sets PepClassification field to given value.

### HasPepClassification

`func (o *EddCustomer) HasPepClassification() bool`
