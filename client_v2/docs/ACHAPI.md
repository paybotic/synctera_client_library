...
[**GetIncomingACHByID**](ACHAPI.md#GetIncomingACHByID) | **Get** /ach/incoming/{id} | Get Incoming ACH Transaction By ID
[**GetIncomingACHList**](ACHAPI.md#GetIncomingACHList) | **Get** /ach/incoming | List Incoming ACH Transactions
...
> IncomingAch GetIncomingACHByID(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ACHAPI.GetIncomingACHByID(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ACHAPI.GetIncomingACHByID``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetIncomingACHByID`: IncomingAch
	fmt.Fprintf(os.Stdout, "Response from `ACHAPI.GetIncomingACHByID`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetIncomingACHByIDRequest struct via the builder pattern
...
> IncomingAchList GetIncomingACHList(ctx).Limit(limit).PageToken(pageToken).Status(status).SettlementDateFrom(settlementDateFrom).SettlementDateTo(settlementDateTo).AccountId(accountId).Execute()
...
func main() {
	...
	settlementDateFrom := time.Now() // string | Start of the settlement date range query (optional)
	settlementDateTo := time.Now() // string | End of the settlement date range query (optional)
	accountId := []string{"7d943c51-e4ff-4e57-9558-08cab6b963c7"} // []string | Account ID (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ACHAPI.GetIncomingACHList(context.Background()).Limit(limit).PageToken(pageToken).Status(status).SettlementDateFrom(settlementDateFrom).SettlementDateTo(settlementDateTo).AccountId(accountId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ACHAPI.GetIncomingACHList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetIncomingACHList`: IncomingAchList
	fmt.Fprintf(os.Stdout, "Response from `ACHAPI.GetIncomingACHList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetIncomingACHListRequest struct via the builder pattern
 ...
 **settlementDateFrom** | **string** | Start of the settlement date range query | 
 **settlementDateTo** | **string** | End of the settlement date range query | 
...
> OutgoingAch GetTransactionOut(ctx).TransactionId(transactionId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ACHAPI.GetTransactionOut(context.Background()).TransactionId(transactionId).Execute()
	if err != nil {
...
> OutgoingAchList ListTransactionsOut(ctx).EffectiveDate(effectiveDate).IncomingAchId(incomingAchId).StartEffectiveDate(startEffectiveDate).EndEffectiveDate(endEffectiveDate).Limit(limit).PageToken(pageToken).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ACHAPI.ListTransactionsOut(context.Background()).EffectiveDate(effectiveDate).IncomingAchId(incomingAchId).StartEffectiveDate(startEffectiveDate).EndEffectiveDate(endEffectiveDate).Limit(limit).PageToken(pageToken).Execute()
	if err != nil {
...
> OutgoingAch PatchTransactionOut(ctx).OutgoingAchPatch(outgoingAchPatch).TransactionId(transactionId).IdempotencyKey(idempotencyKey).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ACHAPI.PatchTransactionOut(context.Background()).OutgoingAchPatch(outgoingAchPatch).TransactionId(transactionId).IdempotencyKey(idempotencyKey).Execute()
	if err != nil {
