...
`func (o *BaseCard) GetLastUpdatedTime() time.Time`

GetLastUpdatedTime returns the LastUpdatedTime field if non-nil, zero value otherwise.

### GetLastUpdatedTimeOk

`func (o *BaseCard) GetLastUpdatedTimeOk() (*time.Time, bool)`
...
`func (o *BaseCard) SetLastUpdatedTime(v time.Time)`

SetLastUpdatedTime sets LastUpdatedTime field to given value.

### HasLastUpdatedTime

`func (o *BaseCard) HasLastUpdatedTime() bool`
