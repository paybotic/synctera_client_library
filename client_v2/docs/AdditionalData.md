...
**TitleOther** | Pointer to **string** | The specific title or professional role at the related organization (required if not one of: &#x60;DIRECTOR&#x60;, &#x60;OFFICER&#x60;, &#x60;FOUNDER&#x60;). | [optional] 
...
`func (o *AdditionalData) GetTitleOther() string`

GetTitleOther returns the TitleOther field if non-nil, zero value otherwise.

### GetTitleOtherOk

`func (o *AdditionalData) GetTitleOtherOk() (*string, bool)`
...
`func (o *AdditionalData) SetTitleOther(v string)`

SetTitleOther sets TitleOther field to given value.

### HasTitleOther

`func (o *AdditionalData) HasTitleOther() bool`
