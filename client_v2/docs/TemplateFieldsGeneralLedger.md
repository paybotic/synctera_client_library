...
`func (o *TemplateFieldsGeneralLedger) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *TemplateFieldsGeneralLedger) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *TemplateFieldsGeneralLedger) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *TemplateFieldsGeneralLedger) HasAccountProgramId() bool`
