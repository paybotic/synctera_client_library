...
`func (o *PatchAccountChargeSecured) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *PatchAccountChargeSecured) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *PatchAccountChargeSecured) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *PatchAccountChargeSecured) HasAccountProgramId() bool`
