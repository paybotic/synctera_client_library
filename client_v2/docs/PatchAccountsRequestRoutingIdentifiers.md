...
**Network** | Pointer to [**ExternalAccountNetwork**](ExternalAccountNetwork.md) |  | [optional] 
...
`func (o *PatchAccountsRequestRoutingIdentifiers) GetNetwork() ExternalAccountNetwork`

GetNetwork returns the Network field if non-nil, zero value otherwise.

### GetNetworkOk

`func (o *PatchAccountsRequestRoutingIdentifiers) GetNetworkOk() (*ExternalAccountNetwork, bool)`
...
`func (o *PatchAccountsRequestRoutingIdentifiers) SetNetwork(v ExternalAccountNetwork)`

SetNetwork sets Network field to given value.

### HasNetwork

`func (o *PatchAccountsRequestRoutingIdentifiers) HasNetwork() bool`
