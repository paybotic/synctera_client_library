...
`func NewNoteCreate(content string, relatedResourceId string, relatedResourceType RelatedResourceType, ) *NoteCreate`
...
`func (o *NoteCreate) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *NoteCreate) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *NoteCreate) SetRelatedResourceType(v RelatedResourceType)`
