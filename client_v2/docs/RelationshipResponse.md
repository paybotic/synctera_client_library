...
**OwnershipPercentage** | Pointer to **float64** | The ownership percentage of the related party. | [optional] 
...
`func (o *RelationshipResponse) GetOwnershipPercentage() float64`

GetOwnershipPercentage returns the OwnershipPercentage field if non-nil, zero value otherwise.

### GetOwnershipPercentageOk

`func (o *RelationshipResponse) GetOwnershipPercentageOk() (*float64, bool)`
...
`func (o *RelationshipResponse) SetOwnershipPercentage(v float64)`

SetOwnershipPercentage sets OwnershipPercentage field to given value.

### HasOwnershipPercentage

`func (o *RelationshipResponse) HasOwnershipPercentage() bool`
