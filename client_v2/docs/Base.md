...
`func (o *Base) SetClassifications(v []Classification)`

SetClassifications sets Classifications field to given value.

### HasClassifications

`func (o *Base) HasClassifications() bool`
...
`func (o *Base) GetCustomerActive() time.Time`

GetCustomerActive returns the CustomerActive field if non-nil, zero value otherwise.

### GetCustomerActiveOk

`func (o *Base) GetCustomerActiveOk() (*time.Time, bool)`
...
`func (o *Base) SetCustomerActive(v time.Time)`

SetCustomerActive sets CustomerActive field to given value.

### HasCustomerActive

`func (o *Base) HasCustomerActive() bool`
