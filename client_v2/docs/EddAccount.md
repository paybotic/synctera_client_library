...
`func NewEddAccount(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, ) *EddAccount`
...
`func (o *EddAccount) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *EddAccount) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *EddAccount) SetRelatedResourceType(v RelatedResourceType)`
