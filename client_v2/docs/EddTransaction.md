...
`func NewEddTransaction(reason string, relatedResourceId string, relatedResourceType RelatedResourceType, ) *EddTransaction`
...
`func (o *EddTransaction) GetRelatedResourceType() RelatedResourceType`

GetRelatedResourceType returns the RelatedResourceType field if non-nil, zero value otherwise.

### GetRelatedResourceTypeOk

`func (o *EddTransaction) GetRelatedResourceTypeOk() (*RelatedResourceType, bool)`
...
`func (o *EddTransaction) SetRelatedResourceType(v RelatedResourceType)`
