...
`func NewSpendControlSingleTransaction(timeRangeType SpendControlTimeRangeType, ) *SpendControlSingleTransaction`
...
`func (o *SpendControlSingleTransaction) GetTimeRangeType() SpendControlTimeRangeType`

GetTimeRangeType returns the TimeRangeType field if non-nil, zero value otherwise.

### GetTimeRangeTypeOk

`func (o *SpendControlSingleTransaction) GetTimeRangeTypeOk() (*SpendControlTimeRangeType, bool)`
...
`func (o *SpendControlSingleTransaction) SetTimeRangeType(v SpendControlTimeRangeType)`
