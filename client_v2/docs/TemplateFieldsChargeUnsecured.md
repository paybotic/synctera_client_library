...
`func NewTemplateFieldsChargeUnsecured(accountType AccountType, bankCountry string, currency string, minimumPayment MinimumPaymentTypeFull, ) *TemplateFieldsChargeUnsecured`
...
`func (o *TemplateFieldsChargeUnsecured) GetAccountProgramId() string`

GetAccountProgramId returns the AccountProgramId field if non-nil, zero value otherwise.

### GetAccountProgramIdOk

`func (o *TemplateFieldsChargeUnsecured) GetAccountProgramIdOk() (*string, bool)`
...
`func (o *TemplateFieldsChargeUnsecured) SetAccountProgramId(v string)`

SetAccountProgramId sets AccountProgramId field to given value.

### HasAccountProgramId

`func (o *TemplateFieldsChargeUnsecured) HasAccountProgramId() bool`
...
`func (o *TemplateFieldsChargeUnsecured) GetMinimumPayment() MinimumPaymentTypeFull`

GetMinimumPayment returns the MinimumPayment field if non-nil, zero value otherwise.

### GetMinimumPaymentOk

`func (o *TemplateFieldsChargeUnsecured) GetMinimumPaymentOk() (*MinimumPaymentTypeFull, bool)`
...
`func (o *TemplateFieldsChargeUnsecured) SetMinimumPayment(v MinimumPaymentTypeFull)`
