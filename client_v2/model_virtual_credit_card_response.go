...
// checks if the VirtualCreditCardResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualCreditCardResponse{}

// VirtualCreditCardResponse A card that can spend against a credit account
type VirtualCreditCardResponse struct {
	// PHYSICAL or VIRTUAL.
...
type _VirtualCreditCardResponse VirtualCreditCardResponse
...
func NewVirtualCreditCardResponse(form string, accountId string, cardProductId string, creationTime time.Time, embossName EmbossName, expirationMonth string, expirationYear string, id string, lastFour string, cardStatus CardStatus, statusReason CardStatusReasonCode, cardBrand CardBrand) *VirtualCreditCardResponse {
	this := VirtualCreditCardResponse{}
	this.Form = form
...
func (o VirtualCreditCardResponse) MarshalJSON() ([]byte, error) {
...
func (o VirtualCreditCardResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualCreditCardResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualCreditCardResponse := _VirtualCreditCardResponse{}

	err = json.Unmarshal(data, &varVirtualCreditCardResponse)

	if err != nil {
		return err
	}

	*o = VirtualCreditCardResponse(varVirtualCreditCardResponse)
...
type NullableVirtualCreditCardResponse struct {
	value *VirtualCreditCardResponse
	isSet bool
}

func (v NullableVirtualCreditCardResponse) Get() *VirtualCreditCardResponse {
	return v.value
}

func (v *NullableVirtualCreditCardResponse) Set(val *VirtualCreditCardResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualCreditCardResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualCreditCardResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualCreditCardResponse(val *VirtualCreditCardResponse) *NullableVirtualCreditCardResponse {
	return &NullableVirtualCreditCardResponse{value: val, isSet: true}
}

func (v NullableVirtualCreditCardResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualCreditCardResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
