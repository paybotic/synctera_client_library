...
// checks if the FeeTemplatePost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeeTemplatePost{}

// FeeTemplatePost struct for FeeTemplatePost
type FeeTemplatePost struct {
	...
	Subtype              FeeSubtypePost         `json:"subtype"`
	AdditionalProperties map[string]interface{}
}

type _FeeTemplatePost FeeTemplatePost
...
func (o FeeTemplatePost) MarshalJSON() ([]byte, error) {
...
func (o FeeTemplatePost) ToMap() (map[string]interface{}, error) {
...
func (o *FeeTemplatePost) UnmarshalJSON(data []byte) (err error) {
	...
	varFeeTemplatePost := _FeeTemplatePost{}

	err = json.Unmarshal(data, &varFeeTemplatePost)

	if err != nil {
		return err
	}

	*o = FeeTemplatePost(varFeeTemplatePost)
...
type NullableFeeTemplatePost struct {
	value *FeeTemplatePost
	isSet bool
}

func (v NullableFeeTemplatePost) Get() *FeeTemplatePost {
	return v.value
}

func (v *NullableFeeTemplatePost) Set(val *FeeTemplatePost) {
	v.value = val
	v.isSet = true
}

func (v NullableFeeTemplatePost) IsSet() bool {
	return v.isSet
}

func (v *NullableFeeTemplatePost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeeTemplatePost(val *FeeTemplatePost) *NullableFeeTemplatePost {
	return &NullableFeeTemplatePost{value: val, isSet: true}
}

func (v NullableFeeTemplatePost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeeTemplatePost) UnmarshalJSON(src []byte) error {
	v.isSet = true
