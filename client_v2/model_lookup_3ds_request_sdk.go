...
// Lookup3dsRequestSdk Details for an External Card Transfer 3-D Secure Authentication lookup request using a SDK
...
func (o *Lookup3dsRequestSdk) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varLookup3dsRequestSdk)
