...
type Wire struct {
	...
	FedInputMessageAccountabilityData *string `json:"fed_input_message_accountability_data,omitempty"`
	// wire ID
	Id string `json:"id"`
...
// GetFedInputMessageAccountabilityData returns the FedInputMessageAccountabilityData field value if set, zero value otherwise.
func (o *Wire) GetFedInputMessageAccountabilityData() string {
	if o == nil || IsNil(o.FedInputMessageAccountabilityData) {
		var ret string
		return ret
	}
	return *o.FedInputMessageAccountabilityData
}

// GetFedInputMessageAccountabilityDataOk returns a tuple with the FedInputMessageAccountabilityData field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Wire) GetFedInputMessageAccountabilityDataOk() (*string, bool) {
	if o == nil || IsNil(o.FedInputMessageAccountabilityData) {
		return nil, false
	}
	return o.FedInputMessageAccountabilityData, true
}
...
// SetFedInputMessageAccountabilityData gets a reference to the given string and assigns it to the FedInputMessageAccountabilityData field.
func (o *Wire) SetFedInputMessageAccountabilityData(v string) {
	o.FedInputMessageAccountabilityData = &v
}
...
func (o Wire) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FedInputMessageAccountabilityData) {
		toSerialize["fed_input_message_accountability_data"] = o.FedInputMessageAccountabilityData
	}
	toSerialize["id"] = o.Id
...
func (o *Wire) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWire)
	...
	*o = Wire(varWire)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "fed_input_message_accountability_data")
		delete(additionalProperties, "id")
		delete(additionalProperties, "input_message_accountability_data")
		delete(additionalProperties, "is_bulk")
		...
		delete(additionalProperties, "transaction_in_id")
