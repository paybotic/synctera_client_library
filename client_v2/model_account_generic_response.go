...
type AccountGenericResponse struct {
	...
	AccountClosure              *AccountClosureResponse `json:"account_closure,omitempty"`
	// Account number
	...
	InClosingDate *string `json:"in_closing_date,omitempty"`
	...
	VendorInfo           *VendorInfoResponse `json:"vendor_info,omitempty"`
...
func (o *AccountGenericResponse) GetAccountClosure() AccountClosureResponse {
	if o == nil || IsNil(o.AccountClosure) {
		var ret AccountClosureResponse
		return ret
	}
...
// SetAccountClosure gets a reference to the given AccountClosureResponse and assigns it to the AccountClosure field.
...
// GetInClosingDate returns the InClosingDate field value if set, zero value otherwise.
func (o *AccountGenericResponse) GetInClosingDate() string {
	if o == nil || IsNil(o.InClosingDate) {
		var ret string
		return ret
	}
	return *o.InClosingDate
}

// GetInClosingDateOk returns a tuple with the InClosingDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AccountGenericResponse) GetInClosingDateOk() (*string, bool) {
	if o == nil || IsNil(o.InClosingDate) {
		return nil, false
	}
	return o.InClosingDate, true
}
...
// SetInClosingDate gets a reference to the given string and assigns it to the InClosingDate field.
...
// SetVendorInfo gets a reference to the given VendorInfoResponse and assigns it to the VendorInfo field.
...
func (o AccountGenericResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InClosingDate) {
		toSerialize["in_closing_date"] = o.InClosingDate
	}
...
func (o *AccountGenericResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AccountGenericResponse(varAccountGenericResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "in_closing_date")
