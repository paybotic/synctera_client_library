...
*ExternalCardsAlphaApi* | [**CreateExternalCardTransferReversal**](docs/ExternalCardsAlphaApi.md#createexternalcardtransferreversal) | **Post** /external_cards/transfers/{transfer_id}/reversals | Create External Card Transfer Reversal
*ExternalCardsAlphaApi* | [**GetExternalCard**](docs/ExternalCardsAlphaApi.md#getexternalcard) | **Get** /external_cards/{external_card_id} | Get External Card
*ExternalCardsAlphaApi* | [**GetExternalCardTransfer**](docs/ExternalCardsAlphaApi.md#getexternalcardtransfer) | **Get** /external_cards/transfers/{transfer_id} | Get External Card Transfer
*ExternalCardsAlphaApi* | [**ListExternalCardTransfers**](docs/ExternalCardsAlphaApi.md#listexternalcardtransfers) | **Get** /external_cards/transfers | List External Card Transfers
