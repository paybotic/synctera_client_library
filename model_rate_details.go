...
// checks if the RateDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RateDetails{}
...
func (o RateDetails) ToMap() (map[string]interface{}, error) {
...
func (o *RateDetails) UnmarshalJSON(data []byte) (err error) {
