...
type HoldCreateRequest struct {
	...
	// The uuid of the account to offset the transaction Note: `offset_account_id` and `account_id` are mutually exclusive.
	OffsetAccountId *string `json:"offset_account_id,omitempty"`
	// The account number to offset the transaction
...
func (o *HoldCreateRequest) GetStatus() HoldCreateRequestStatus {
	if o == nil {
		var ret HoldCreateRequestStatus
		return ret
	}
