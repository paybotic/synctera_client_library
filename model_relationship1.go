...
// checks if the Relationship1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Relationship1{}
...
func (o Relationship1) ToMap() (map[string]interface{}, error) {
