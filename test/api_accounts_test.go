...
func Test_synctera_client_AccountsAPIService(t *testing.T) {
	...
	t.Run("Test AccountsAPIService InitiateAccountClosure", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var accountId string

		resp, httpRes, err := apiClient.AccountsAPI.InitiateAccountClosure(context.Background(), accountId).Execute()
	...
	t.Run("Test AccountsAPIService ListStopPayment", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.AccountsAPI.ListStopPayment(context.Background()).Execute()
