...
// checks if the WatchlistAlertList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatchlistAlertList{}
...
func (o WatchlistAlertList) ToMap() (map[string]interface{}, error) {
