...
func (o *Deposit) GetOcrAccountNumber() string {
	if o == nil || o.OcrAccountNumber == nil {
		var ret string
		return ret
	}
...
func (o *Deposit) GetOcrRoutingNumber() string {
	if o == nil || o.OcrRoutingNumber == nil {
		var ret string
		return ret
	}
