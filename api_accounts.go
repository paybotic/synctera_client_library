...
func (a *AccountsAPIService) ListAccountsExecute(r ApiListAccountsRequest) (*AccountList, *http.Response, error) {
	...
	if r.accountNumber != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "account_number", r.accountNumber, "csv")
	}
	if r.lastName != nil {
	...
	if r.overflowAccountId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "overflow_account_id", r.overflowAccountId, "csv")
	}
	if r.accountType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "account_type", r.accountType, "")
	}
	...
	if r.overdraftAccountId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "overdraft_account_id", r.overdraftAccountId, "csv")
	}
	if r.spendControlIds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "spend_control_ids", r.spendControlIds, "csv")
	}
	if r.pageToken != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "page_token", r.pageToken, "")
	}
	...
	if r.customerType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "customer_type", r.customerType, "")
	}
	if r.limit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "")
	} else {
	...
	if r.interestProductId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "interest_product_id", r.interestProductId, "")
	}
	if r.linkedAccountId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "linked_account_id", r.linkedAccountId, "csv")
	}
	if r.id != nil {
